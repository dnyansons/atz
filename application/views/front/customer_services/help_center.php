...
<style type="text/css">     
.common-search{padding :90px;	width: 100%;}
.active{color:red !important;}
a{cursor:pointer;}
</style>
<div class="help-center newhelpCenter">
    <div class="grid common-search">
        <div class="help-title-tip h1 text-white">How Can We Help?</div>
    </div>	
    <div class="mod-main container-fluid px-5">
        <div class="breadcrumb">
            <div class="en-us" >
                <div class="ui-breadcrumb">
                    <a href="">Help Center</a>
                    <span class="divider">&gt;</span>
                    <span class="">atzcart.com</span>
                </div>
            </div>
        </div>
...
$(document).ready(function(){
	 ...
	 $.ajax({
        url : '<?php echo base_url(); ?>customer_service/get_titles',
        dataType: 'json',
        type: 'POST',
...
function getSubtitles(id)
{
    ...
    $.ajax({
        url : '<?php echo base_url(); ?>customer_service/ajxgetSubtitles/'+id,
        dataType: 'json',
        type: 'POST',
        success: function(data){
            if(data)
...
function get_description(id)
{
	...
	$.ajax({
        url : '<?php echo base_url(); ?>help-center-description/'+id,
        dataType: 'json',
        type: 'POST',
        success: function(data){
            if(data)
