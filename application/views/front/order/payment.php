...
.waves-effect {
            ...
            <div id="draft" class="draft">
                ...
                <div>
                    <a href="<?php echo base_url(); ?>"><div id="brandIntro_1" class="brand-intro" style="height: 20px;">
                            <h2><img style="width:200px;" src="<?php echo base_url(); ?>assets/front/images/logo/logo.png"> </h2></a>
                </div>
            </div>
            <br>
            <div>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="next-table-cell">
                                                                    <div class="next-table-cell-wrapper pb-5">
                                                                        <?php
                                                                        if ($specifications->specifications[$i]->specifications->case_type > 2 || $specifications->specifications[$i]->specifications->case_type == 2) {
                                                                            ...
                                                                            for ($j = 0; $j < count($specifications->specifications[$i]->specifications->secondary); $j++) {
                                                                                ...
                                                                                if ($j == 0) {
                                                                                    ...
                                                                                    ?> : <?php
                                                                                    echo $specifications->specifications[$i]->specifications->primary->spec_value . "<br>";
                                                                            ...
                                                                            ?>
                                                                            <strong><?php echo $specifications->product_name; ?></strong>
                                                                        <?php } ?>
                                                                    </div>
                                                                </td>
                                                                <td class="next-table-cell">
                                ...
                                <div class="next-col block-footer-left">
                                    <div id="productsAmountBlock_1" class="block draft-productsAmountBlock">
                                        <div class="biz-products-amount">
                                            <label><span>Subtotaal(<?php echo $count_item; ?> Items) without shipping:</span></label>
                                            <span>
            ...
            <?php if ($pending_order == 'Accepted') { ?>
                <div style="">
                            ...
                            <div class="next-row next-row-justify-center block-footer" id="shippingFooter_1">
                                <div class="next-col block-footer-left">
                                    <div class="biz-shipping-fee"><label><span data-i18n-ns="ta.order.buynow.shipping_fee" data-i18n-key="label">Shipping
                                                Fee:</span></label><span class="biz-shipping-fee-value">
                                            <span data-i18n-ns="ta.order.buynow.shipping_fee"
                                                  data-i18n-key="no_fee">
                    <i class="fa fa-inr"></i> <?php echo $order_dtail['shipping_cost']; ?></span></span></div>
                    <div class="biz-shipping-fee"><label><span data-i18n-ns="ta.order.buynow.shipping_fee" data-i18n-key="label">Total Amount:</span></label><span class="biz-shipping-fee-value"><span data-i18n-ns="ta.order.buynow.shipping_fee"
                                                                                                                                                                                                            data-i18n-key="no_fee"><i class="fa fa-inr"></i> <?php echo number_format($order_dtail['order_price'], 2); ?></span></span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div style="">
                    ...
                    <div class="biz-action-bar">
                        <div class="biz-action-bar-inner">
                            ...
                            <div>
                                <input class="next-btn next-btn-primary next-btn-large biz-action-bar-button payment" id="submit-pay" type="button" 
                                onclick="" value="Make Payment" class="btn btn-primary" />
    ...
    <script src="<?php echo base_url('assets/front/js/jquery.inputmask.bundle.js')?>"></script>
