...
<html class="no-js" lang="en">
    ...
    <body style="background:#f3f3f5 url(src/assets/front/images/back.png);background-repeat: no-repeat;" id="overlay">
        ...
        <div class="main" style="background-color: #f7f8fa;">
            <img src="<?php echo base_url(); ?>assets/loader.gif" class="loading-image" style="display:none;">
            <div id="draft" class="draft">
                ...
                <div>
                    <div class="next-step next-step-arrow next-step-horizontal base-step draft-stepBlock stepBlock_1">
                        <div data-spm-click="gostr=/sc.1;locaid=d_step;step=Start Order" class="next-step-item next-step-item-process next-step-item-first"
                             style="width: auto;">
                ...
                <div>
                    <?php
                    //if user goes out of stock then don't process payment.
                    $low_stock_one = array();
                    if ($cart_product) {
                        $discount = 0;
                        $total_amount = 0;
                                        ...
                                        <div class="next-row biz-supplierLite-header">
                                            <div class="next-col next-col-16">
                                                ...
                                                <span class="biz-supplierLite-value">
                                                    <span>
                                                        <?php echo $cart_product[0]['supplierDetails']; ?>
                                                    </span>
                                            ...
                                            <div class="next-table-header">
                                                <div class="next-table-header-inner">
                                                    <table>
                                                        ...
                                                        <div class="next-table-cell-wrapper"><strong>Total Amount</strong></div>
                                                        </th>
                                                        </tr>
                                                        </thead>
                                                    </table>
                                            ...
                                            <div class="next-table-body">
                                                <table>
                                                    <tbody>
                                                        ...
                                                        $k = 0;
                                                        $seller_id = 0;
                                                        foreach ($cart_product as $details) {

                                                            $specifications = $details['specifications_decode'];
...
//												 $count_item += count($specifications);
                                                            for ($i = 0; $i < count($specifications); $i++) {
                                                                ...
                                                                <tr>
                                                                        ...
                                                                        <div class="next-table-cell-wrapper">
                                                                            <div class="biz-sku-infos">
                                                                                <div class="pic"><img src="<?php echo $details['product_image']; ?>"
                                                                                                      class="media-side img-thumbnail"></div>
                                                                                <div class="detail">
                                                                    ...
                                                                    echo $specifications[$i]->specifications->secondary[$j]->specification_name;
                                                                                ...
                                                                                ?>
                                                                                <div class="next-table-cell-wrapper"><strong><?php echo $details['product_name']; ?></strong></div>
                                                                            <?php } ?>
                                                                        </div>
                                                                    </td>
                                                                    <td class="next-table-cell">
            ...
            <?php echo ($qnty) ? $qnty : $specifications[$i]->specifications->total_quantity; ?> (<?php echo $specifications[$i]->specifications->unit_name; ?>)
                                                                    ...
                                                                    <td class="next-table-cell">
                                                                        <div class="next-table-cell-wrapper">
                                                                            <input type="hidden" id="prodd_id" value="<?php echo $details['product_id']; ?>">
                                                                            ...
                                                                            $total_quantity_shopped = $specifications[$i]->specifications->total_quantity;
                                                                            ...
                                                                            if ($low_stock == 0) {
                                                                                ...
                                                                                $low_stock_one[] = $details['product_id'];
                                                                            }
            ...
            ?>
                                                                ...
                                                                $total_quantity = $specifications[$i]->specifications->total_quantity;
                                                                $unit_price = $specifications[$i]->specifications->unit_price;
                                                                $seller_id = $details['seller_id'];
                                                                $coupon_id = $specifications[$i]->specifications->coupon_id;
                                                            }
                                                            $cart_product[$k]['total_quantity'] = $total_quantity;
                                                            $cart_product[$k]['unit_price'] = $unit_price;
                                                            $cart_product[$k]['coupon_id'] = $coupon_id;
                                                            $cart_product[$k]['final_price'] = $total_quantity * $unit_price;
                                                            $cart_product[$k]['specifications'] = $specifications;
                                                            unset($cart_product[$k]["specifications_decode"]);
                                                            $k++;
                                                        }
                                                        ?>
    ...
    <?php
    if ($shipping_type == 'Free' && $tot_price >= 500) {
        echo '<label><span>Total product amount</span></label>';
    } else {
        echo'<label><span>Total product amount without shipping:</span></label>';
    }
    ?>
                                                <span>
...
<?php } ?>
                ...
                <div class="walletDiv">
                    <div class="ui2-box so-extraBlock">
                        <div class="ui2-box-wrap">

                            <div>
                                <div class="next-form-item next-row shipping-item" label="Shipping method">
                                    <!--<label class="next-col-3 next-form-item-label">Shipping method : </label>-->
                                    <div class="container next-form-item-control">
                                        <input type="hidden" name="shipping_method" id="shipping_method" value="Land Transportation">
              <!-- <span style="margin-top:5px;font-weight:bold;">Land Transportation</span>
                            ...
                            <div class="next-form-item next-row" id="shippingAddress_shippingAddress_1" label="[object Object]" required="">
                                <label
                                    for="shippingAddress_shippingAddress_1" required="" class="next-col-4 next-form-item-label"><span
                                        data-i18n-ns="ta.order.com.shippingaddress.form-item">Shipping
                                        Address:</span></label>
                                <div class="next-col-20 next-form-item-control" id="all_address">
                                    <div class="bc-icbu-shipping-address-container">
                                        ...
                                        if (!empty($user_addr)) {
                                            ...
                                            foreach ($user_addr as $addr) {
                                                ...
                                                ?>
                                                <div class="col-md-12 input-group" style="width: 265px;padding-top:9px;margin-bottom:10px;">
                                                    <input type="radio" onclick="check_returnable();" name="shipp_addr" value="<?php echo $addr['address_book_id']; ?>" id="shipp_addr" <?php echo $checked; ?>>

                                                    <span style="margin-top:-15px; margin-left:15px;"><?php echo $addr['contact_person']; ?> , 
                                                <?php echo $addr['street']; ?> , 
                                                <?php echo $addr['city'] . ',' . $addr['state']; ?><br>
                                                <?php echo 'India' . ',' . $addr['postcode']; ?></span>
                                                </div>
...
?>
                                        <br>
                                        <div id="shipping_prompt" style="margin-left:45px;"></div>

                                        <div style="margin-left:45px;">
                                            <div class=""><a class="btn btn-danger btn-outline-danger btn-sm" data-toggle="modal" data-target="#ship_address" id="popup">Add Shipping Address</a></div>
                                        </div>

                                    </div>
                                    <hr style="margin-top:-10px;">
                                               <p id="ch_return" style="margin-top:-50px;"></p>
                                </div>
                            </div>

                            <div style = "color:red" id="rd_button"></div>
                ...
                <div>
                    <div class="biz-action-bar">
                        ...
                        <div class="biz-action-bar-inner">
                            <div class="action-bar-submit-tips">
                            </div>
                            <div>
                            <?php if (count($low_stock_one) == 0) { ?>
                                    <a href="javascript:void(0)" data-total-quantity="<?php echo $total_quantity; ?>" data-productname = "<?php echo $product_name; ?>" data-product-id="<?php echo $product_id; ?>" data-total-amount = "<?php echo $total_amount; ?>"  data-tot-price = "<?php echo $tot_price; ?>"  data-seller-id = "<?php echo $seller_id; ?>"  id="start_order">

                                        <button type="submit" class="next-btn next-btn-primary next-btn-large biz-action-bar-button">Make Payment </button></a></div>
                            <?php
                            } else {
                                $error = '<div class="alert alert-danger alert-dismissible">
                                        <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                        <strong>Error! : </b></strong>' . $details['product_name'] . " product is out of stock!" . ' 
                                        </div>';
...
<?php } ?>
            ...
            <div id="ship_address" class="modal"  role="dialog">
                <div class="modal-dialog modal-dialog-centered modal-lg">
                    <!-- Modal content-->
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" >Add Address </h4>
                            <button type="button" style="font-size: 12px;float:right;margin-top: 25px;" class='btn btn-sm btn-danger pull-right' onclick="getLocationDetails()">Get Current Location</button>
                        </div>
                        <form class="form-horizontal" action="<?php echo base_url(); ?>" method="post" id="form_id" >
                            <div class="modal-body">
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="contact_person" id="contact_person" maxlength="60" value="<?php echo set_value('contact_person'); ?>">
                                        </div>
                                ...
                                <div class="row">			
                                    <div class="col">				
                                        <div class="form-group">
                                            <label for="contact_person">Contact Number <span style="color:red">*</span></label>
                                            <input type="text" class="form-control"  maxlength="15" name="contact_number" id="contact_number" value="<?php echo set_value('contact_number'); ?>">
                                        </div>
                                    ...
                                    <div class="col">				
                                        <div class="form-group">
                                            <label for="contact_person">Address <span style="color:red">*</span></label>
                                            <input type="text" class="form-control" name="street1" id="street1">
                                        </div>
                                        <p id="error_street1" style="color:red;"></p>
                                    </div>
                                </div>
                                <div class="row">			
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            <label for="contact_person">Postcode <span style="color:red">*</span></label>
                                            <input type="text" class="form-control"  maxlength="6" name="postal_code" id="postal_code" value="<?php echo set_value('postal_code'); ?>">
                                        </div>
                                        <p id="error_postal_code" style="color:red;"></p>
                                    </div>

                                    <div class="col">
                                        <div class="form-group">
                                            <label for="contact_person">City <span style="color:red">*</span></label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            <label for="contact_person">State <span style="color:red">*</span></label>
                                            <input type="text" class="form-control" id="state" name="state">
                                        </div>
                                        <p id="error_state" style="color:red;"></p>
                                    </div>
...
<?php echo form_error('tag'); ?>
                                ...
                                <p id="error_addr" style="text-align:center;color:red;"></p>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-sm btn-danger" data-dismiss="modal">Close</button>
                                <button type="button" onclick="submit_address()" class="btn btn-sm btn-danger" id="btnSubmit" >Add Address</button>
                            </div>  
        ...
        <script>
                                    ...
                                    {
                                        var prod_id = $('#prodd_id').val();
                                        var pincode = $("input[name='shipp_addr']:checked").val();
                                        if (prod_id != '' && pincode != '') {
                                            $.ajax({
                                                url: '<?php echo base_url(); ?>userorder/check_returnable',
                                                method: 'POST',
                                                data: {prod_id: prod_id, pin_id: pincode},
                                                success: function (data) {

                                                    var dat = data.split('|');
                                                    if (dat[0] == 1 && dat[1]!='')
                                                    {
                                                        $("#ch_return").html("<span style='color:green'>This Order is Returnable at " + dat[1] + " Pincode.</span>");
                                                    }
                                                    if (dat[0] == 0 && dat[1]!='') {
                                                        $("#ch_return").html("<span style='color:red'> This Order Not Returnable at  " + dat[1] + "  Pincode.</span>");
                                                    }
        ...
        <script>
            $(document).ready(function () {
                ...
                $('#contact_person').on('keypress', function (event) {
            ...
            $('#start_order').click(function () {
                ...
                var shipp_addr = $("input[name='shipp_addr']:checked").val();
                var shipping_method = $("#shipping_method").val();
                var tot_price = $(this).data('tot-price');
                var tempList = '<?php echo json_encode($cart_product); ?>';
                var chk_wallet_val = $('#chk_wallet_val').val();
                var wallet_amount = $('#wallet_amount').val();
                $('#loading-image').show();

                if (shipp_addr) {
                    $("#shipping_prompt").html("");
                    $.ajax({
                        url: '<?php echo base_url(); ?>proceedResponseCartProduct',
                        method: 'POST',
                        dataType: 'json',
                        data: {total_amount: total_amount, tot_price: tot_price, shipp_addr: shipp_addr, shipping_method: shipping_method, seller: seller, tempList: tempList, chk_wallet_val: chk_wallet_val, wallet_amount: wallet_amount},
                        success: function (data) {
                            ...
                            if (data.status == 1)
                            {
                                window.location.href = '<?php echo site_url(); ?>userorder/ship_order/' + data.insert_id;
                            }
                            if (data.status == 2)
                            {
                                window.location.href = '<?php echo site_url(); ?>startOrderForCartProduct/' + seller;
                            }
                            else if (data.status == 3)
                            {
                                var error = '<div class="alert alert-danger alert-dismissible"><a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a><strong>Error!</strong> Invalid UserAddress!.</div>'
                                $("#error").html(error);
                            } else {
                                var error = '<div class="alert alert-danger alert-dismissible"><a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a><strong>Error!</strong> Product Not Available!.</div>'
                                $("#error").html(error);
                            }
                        }
                    });
                } else {
                    $("#shipping_prompt").html("<span style='color:red'>Please Select The Shipping Address.</span>");
                }
            });
        </script>
        ...
        <script>
            function submit_address()
            {
                ...
                $.ajax({
                    type: 'POST',
                    url: '<?php echo base_url(); ?>buyer/addressbook/add_address_ajax',
                    ...
                    success: function (data) {
                        if (data == 1)
                        {
                            alert('New Address Add Successfully !')
                            show_all_address();

                            $('#ship_address').modal('hide');
                        }
                        else
                        {
                            $('#error_addr').html('');
                            $('#error_addr').html(data);
                        }
            ...
            function show_all_address()
            {
                $.ajax({
                    type: 'POST',
                    url: '<?php echo base_url(); ?>buyer/addressbook/all_user_address',
                    data: {},
                    success: function (data) {

                        $('#all_address').html('');
                        $('#all_address').html(data);
