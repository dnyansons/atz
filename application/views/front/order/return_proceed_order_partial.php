    ...
    <div>
                        ...
                        <div id="productsHeader_1" class="block draft-productsHeader">
                           <div class="biz-supplierLite">
                              <div class="next-row biz-supplierLite-header">
                                 ...
                                 <div class="next-col biz-supplierLite-showaction"><span onclick = "show_details()">Show supplier's details</span><i class="next-icon next-icon-arrow-down next-icon-xs"></i></div>
                              </div>
							  ...
							  <div class="next-row">
								<div class="next-col biz-supplierLite-showaction"><span onclick = "hide_details()">Hide supplier's details</span><i class="next-icon next-icon-arrow-up next-icon-xs"></i></div>
							  </div>
							 </div>
                           </div>
                        </div>
                                    ...
                                    <table>
                                       <tbody>
										  ...
										  <td class="next-table-cell first">
                                             ...
                                             <td class="next-table-cell">
                                                <div class="next-table-cell-wrapper">
                                                   <input type = "text" name ="quantity" class="form-control" value="<?php echo ($qnty) ? $qnty: $specifications[$i]->specifications->total_quantity; ?>" id="quantity">
                                                </div>
                                             </td>
                                             <td class="next-table-cell">
                                                <div class="next-table-cell-wrapper">
                              ...
                              <div id="productsAmountBlock_1" class="block draft-productsAmountBlock">
                                 <div class="biz-products-amount">
                                    ...
                                    <span style="color:red">
                                      INR.<?php echo number_format($total_amount,2); ?>
      ...
      <div class="biz-action-bar">
        <div class="biz-action-bar-inner">
          ...
          <div>
              <input style="width:150px;" onclick="return confirm_return()" type="submit" name="submit" value="Conform Return" class="next-btn next-btn-primary next-btn-large biz-action-bar-button">
