...
<html class="no-js" lang="en">
    ...
    <body style="background:#f3f3f5 url(src/assets/front/images/back.png);background-repeat: no-repeat;" >
                                        ...
                                        <div class="biz-supplierLite">
                                            <div class="next-row biz-supplierLite-header">
                                                <div class="next-col next-col-16">
                                                    ...
                                                    <span
                                                        ...
                                                        <span>
                                                            <?php echo $sess_data['supplierDetails']; ?>
                                                        </span>
                                                    </span>
                                                </div>
                                            ...
                                            <div class="biz-supplierLite-body" id="seller_details">
                                                <div class="next-row">
                                                    ...
                                                    <div class="next-col biz-supplierLite-value"><?php echo $sess_data['sellername']; ?></div>

                                                </div>
                                                <div class="next-row">
                                                    <div class="next-col next-col-3 biz-supplierLite-label"><span>Company Name</span></div>
                                                    <div class="next-col biz-supplierLite-value"><?php echo $sess_data['companyname']; ?></div>
                                                </div>
                                                <div class="next-row">
                                                    <div class="next-col next-col-3 biz-supplierLite-label"><span>Address</span></div>
                                                    <div class="next-col biz-supplierLite-value"><?php echo $sess_data['address']; ?></div>
                                                </div>
                                                <div class="next-row">
                                                    <div class="next-col next-col-3 biz-supplierLite-label"><span>Business Type</span></div>
                                                    <div class="next-col biz-supplierLite-value"><?php echo $sess_data['businesstype']; ?></div>
                                                </div>

                                                <div class="next-row">
                                                    <div class="next-col next-col-3 biz-supplierLite-label"><span>Country/Region</span></div>
                                                    <div class="next-col biz-supplierLite-value"><?php echo ucfirst(strtolower($sess_data['countryname'])); ?></div>
                                                </div>
                                                <div class="next-row">
                                            ...
                                            <div class="next-table-inner">
                                                ...
                                                <div class="next-table-body">
                                                    <table>
                                                        <tbody>
                                                            <?php
                                                            $specifications = $sess_data['specifications'];
                                                            $tot_price = 0;
//                                                            $count_item = count($specifications);
                                                                    ...
                                                                    <td class="next-table-cell first">
                                                                        <div class="next-table-cell-wrapper">
                                                                            <div class="biz-sku-infos">
                                                                                <div class="pic"><img src="<?php echo $sess_data['product_image']; ?>"
                                                                                                      class="media-side img-thumbnail"></div>
                                                                                <div class="detail">
                                                                                    <div class="name">
                                                                                        <input type = "hidden" name="product_name" value="<?php echo $sess_data['product_name']; ?>" >
                                                                                        <input type = "hidden" name="product_id" value = "<?php echo $sess_data['product_id']; ?>" >
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="next-table-cell-wrapper">
                                                                            <strong>
                                                                                ...
                                                                                if ($specifications[$i]['specifications']['case_type'] > 2 || $specifications[$i]['specifications']['case_type'] == 2) {
                                                                                    echo $sess_data['product_name'] . '<br>';
                                                                                    ?>
                                                                                    </br></strong>
                                                                                <?php
                                                                                ...
                                                                                echo '<strong>' . $sess_data['product_name'] . '</br></strong>';
                                                                                for ($j = 0; $j < count($specifications[$i]['specifications']['secondary']); $j++) {
                                                                                    echo $specifications[$i]['specifications']['secondary'][$j]['specification_name'];
                                                                                    ?> : <?php
                                                                                ...
                                                                                ?>
                                                                                <strong>
                                                                                    <?php echo $sess_data['product_name']; ?></br></strong>
                                                                            <?php } ?>
                                                                        </div>
                                                                    </td>
                                                                    <td class="next-table-cell">
                                                                        <div class="next-table-cell-wrapper">
                                                                            ...
                                                                            //if product is out of stock then do not process pending orders
                                                                             $low_stock = $this->Order_model->checkProductAvailQty($sess_data['product_id']);
                                                                             if($low_stock == 0) {
                                                ...
                                                <input type = "hidden" name="total_quantity" value="<?php echo $sess_data['specifications'][0]['specifications']['total_quantity']; ?>" >
                                                <input type = "hidden" name="unit_price" value="<?php echo $sess_data['specifications'][0]['specifications']['unit_price']; ?>" >
                                                <input type = "hidden" name="tot_price" value="<?php echo $tot_price; ?>" >

                                                <!--<input type = "hidden" name="total_amount" value="<?php echo $total_amount; ?>" >-->
                                                <input type = "hidden" name="seller_id" value="<?php echo $sess_data['seller']; ?>" >
                                        ...
                                        <div class="next-col block-footer-left">
                                            <div id="productsAmountBlock_1" class="block draft-productsAmountBlock">
                                                <div class="biz-products-amount">
                                                    <label><span>Total product amount without shipping:</span></label>
                                                    <span>
                    ...
                    <div style="display:none;" >
                        ...
                        <div class="ui2-box so-extraBlock">
                            <div class="ui2-box-wrap" data-spm-anchor-id="a2700.8592591.0.i1.7bdf10a9eV3SXz">
                                    ...
                                    <div class="next-form-item next-row shipping-item" label="Shipping method">
                                        ...
                                        <div class="container next-form-item-control">
                                            ...
                                            <div class="col-xs-12 col-md-8">
                                             ...
                                             name="chk_wallet_val">
                                             <input class="checkboxClass" type='hidden' id="chk_wallet_val" name='chk_wallet_val'>
                        ...
                        <div id="shippingBlock_1" class="biz-block-card-wrap biz-block-card-wrap-undefined card draft-shippingBlock">
                            ...
                            <div class="biz-block-card-body">
                                <div class="next-form-item next-row" id="shippingAddress_shippingAddress_1" label="[object Object]" required="">
                                    <label
                                        for="shippingAddress_shippingAddress_1" required="" class="next-col-4 next-form-item-label"><span>Shipping
                                            Address:</span></label>
                                    <div class="next-col-20 next-form-item-control" id="all_address">
                                        <div class="bc-icbu-shipping-address-container">
                                            ...
                                            if (!empty($user_addr)) {
                                                $i = 1;
                                                foreach (array_reverse($user_addr) as $addr) {
                                                    ...
                                                    ?>
                                                    <div class="col-md-12 input-group" style="width: 265px; padding: 9px;">
                                                        <input type="radio" name="shipp_addr" value="<?php echo $addr['address_book_id']; ?>" <?php echo $checked; ?>required>
                                                        <span style="margin-top:-5px; margin-left:10px;"><?php echo $addr['contact_person']; ?>, 
                                                            <?php echo $addr['street']; ?><br>
											...
											<a class="btn btn-danger btn-outline-danger btn-sm" id="popup" data-toggle="modal" data-target="#ship_address">Add Shipping Address</a>
                    ...
                    <div class="row col-xs-12 col-md-12" >
                        ...
                        <div class="biz-action-bar">
                            <div class="biz-action-bar-inner">
                                ...
                                <div>
                                 <input type="hidden" name="order_price" id="order_price" value="<?php echo $tot_price ?>">
                                    <button type="submit" class="blockButton2 next-btn next-btn-primary next-btn-large biz-action-bar-button">Make Payment
                                        &nbsp;<span id="total_order_price"></span></button>
                                </div>
                            </div>
                        </div>
                    </div>
