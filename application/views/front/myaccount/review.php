            ...
            <div class="row">
                <div class="col-lg-12 px-0 pr-lg-2 mb-2 mb-lg-0">
                    <div class="card border-light bg-white card proviewcard shadow-sm">
                        <div class="card-header">All Review</div>
                        ...
                        <div class="card-body">
						    ...
						    <th>Date</th>
                                    ...
                                    <tr>
                                         ...
                                         <td><?php echo $re->reviews_id; ?></td>
                                          <td><?php echo $re->products_name; ?></td>
                                           <td><?php echo $re->reviews_rating; ?></td>
                                             <td><?php echo date('d M Y H:i',strtotime($ord->date_added)); ?></td>
