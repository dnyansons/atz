...
<style>
    ...
    .coupon-card {
        ...
        height: 92px;
        margin-bottom: 13px;
        background: url("<?php echo base_url();?>assets/front/images/banner/coupon.svg") no-repeat
    }
    ...
    .coupon-card .card-info .card-info-price, .coupon-card .card-info .card-info-time {
        color: #666;
        font-size: 12px;
        line-height: 16px;
        overflow: hidden;
                        ...
                        <div class="main-content">
                            <div class="detail-col esite-clearfix" id="J-ls-grid-action">
                                <div class="action-sub">
                                    <div class="detail-box">
                                        <div class=" col">
                                            <?php
                                            $maxQuantity = 0; //means no limit for max quantity. 
                                                             //Will be used only if quantity reaches low stock
                                            
                                            $offer_id = "0";//so as to set offer status inactive after offer ends
                                            $discount_unit = '%'; // by default offer percentage // using this to better manage flat discount
                                            $offer_end_datetime = "";// after setting it used by offer_timer span
                                            $offerStatus = ""; // to be used by javascript for offer_timer
                                            $hideTimer = false;//if product is available then run timer
                                            
                                            if ($product["available_quantity"] <= $product['low_stock_qty']) {
                                                $maxQuantity = $product["available_quantity"];
                                            } 
                                            
                                            if($product["available_quantity"] <= 0){
                                              $disabled = "disabled";
                                              $maxQuantity = -1; // so as to disable + and - quantity button
                                                                 // iff available_quantity
                                                                 // out of stock
                                            } else {
                                                 $disabled = "";
                                            }
                                            ...
                                            ?>
                                            <div class="widget-detail-booth-image J-disable-event app-figure"
                                                 id="zoom-fig">
                                                <a id="Zoom-1" class="MagicZoom" href="<?php echo $defaultImg; ?>">
                                                    <img src="<?php echo $defaultImg; ?>" alt=""
                                                ...
                                                <div class="favorite-corner J-sc-fav-item-wrap"
                                                    ...
                                                    <div class="J-scc-favorite-manager-label scc-favorite-manager-label scc-fav-label-onlyicon scc-fav-icon-bkg">
                                                        <a href="javascript:void(0)" class="add_favorite"
                                                           data-product-id="<?php echo $product['id']; ?>"><?php $fav_prod = $this->session->userdata("faverite_products");
                                                            if (in_array($product['id'], $fav_prod)) { ?><i
                                                                    class="fa fa-heart scc-fav-i-heart-n-normal-small label-icon-mail"
                                                                    style="color:red;"></i><?php } else { ?> <i
                                                                    class="fa fa-heart scc-fav-i-heart-n-normal-small label-icon-mail"></i><?php } ?>
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="scc-wrapper detail-module module-mainAction" data-spm="maonnacta">
                                            <div class="widget-main-action widget-main-action-ws"
                                                ...
                                                <div class="ma-title-wrap">
                                                    <span class="ma-title" title="<?php echo $product['name']; ?>"
                                                          style="font-size:18px">
                                                    <?php echo $product['name']; ?>
                                                    <?php if(strtolower($product['offer_status']) == 'active') {
                                                          $offer_end_datetime = $product['offer_end_time'];
                                                          $offer_id = $product['offer_id'];
                                                          $offerStatus = $product['offer_status'];
                                                          echo "<p class='p-0 m-0 text-success font-weight-bold'  id='offer_timer'></p>";
                                                          
                                                    } 
                                                    
                                                    if($maxQuantity > 0){//!= 0 && $maxQuantity != -1) {//show only if quantity reaches low stock
                                                        echo "<p class='p-0 m-0 text-danger font-weight-bold'><b>Hurry!</b> Only $maxQuantity ".$product_prices[0]['units_name']." left in a stock</p>";
                                                    }
                                                ...
                                                <div class="ma-main">
                                                            ...
                                                            <?php foreach ($product_prices as $prices) { ?>
                                                                <li data-role="ladder-price-item"
                                                                    ...
                                                                    <div class="ma-quantity-range" title="1-99 Boxes">
                                                                        <?php echo $prices['quantity_from'] . '-' . $prices['quantity_upto'];
                                                                        echo '&nbsp;' . $prices['units_name']; ?>
                                                                    </div>
                                                                    <div class="ma-spec-price ma-price-promotion">
                                                                    <span class="priceVal"
                                                                          title="<?php echo sprintf("%01.2f", $prices['final_price']); ?>"><i
                                                                                class="fa fa-inr"></i>&nbsp;<?php
                                                                        $discount = "<strong><span class='text-success'>" . $product['discount'] . " </span> </strong>";
                                                                        echo sprintf("%01.2f", $prices['final_price']);
                                                                        ?>
                                                                    </span>
                                                                    </div>
                                                                    <?php
                                                                    if ($prices['mrp'] != $prices['final_price'] && $prices['mrp'] != 0) {
                                                                        echo "<span style='color:black'> <i class='fa fa-inr'></i> <span class='price-new text-mute'><del>" . sprintf("%01.2f", $prices['mrp']) . "</del></span></span> ";
                                                                        echo $discount;
                                                                    }
                                                                    ?>
                                                                </li>
                                                    ...
                                                    <?php if ($coupons) {
                                                        ...
                                                        <!--coupan code--->
                                                        <div class="detail-coupon" id="detail-coupon"
                                                                            ...
                                                                            <li class="coupon-card">
                                                                                <div class="card-info">
                                                                                    ...
                                                                                    <div class="card-info-price">
                                                                                        Product value more than
                                                                                        MOQ <?php echo $row->moq; ?>,
                                                                                        Capped at US $100
                                                                                    </div>
                                                                                ...
                                                                                <div class="card-action"
                                                                                    ...
                                                                                    <div class="action-text"
                                                                                         id="_<?php echo $i; ?>"
                                                                                         onclick="getCoupons('<?php echo $row->moq; ?>','<?php echo $row->coupon_value; ?>','<?php echo $row->coupon_uniqe_id; ?>', this.id)">
                                                                                        Get Coupon
                                                                                    </div>
                                                                                </div>
                                                                            </li>
                                                    ...
                                                    <?php if ($product_specification) { ?>
                                                        <div class="ma-brief-list ma-main-brief-list">
                                                            <div id="skuWrap" class="sku-wrap">
                                                                <dl id="item-span"
                                                                    class="sku-attr-dl util-clearfix IMAGE">
                                                                    <?php
                                                                    ...
                                                                    if ($count == 1) {
                                                                        ...
                                                                        foreach ($product_specification as $key => $spec) {
                                                                            ?>
                                                                            <dt class="name"
                                                                                title="Color"><?php echo $key; ?>:
                                                                            </dt>
                                                                            <input type="hidden" class="class_Type"
                                                                            ...
                                                                            <dd class="sku-attr-val value util-clearfix">
                                                                                <?php foreach ($spec as $value) {
                                                                                    ...
                                                                                    ?>
                                                                                    <span class="text-frame sku-attr-val-frame"
                                                                                          style="width:50px"
                                                                                          title="<?php echo $value['spec_value']; ?>"
                                                                                          id="currentItem_<?php echo $i; ?>"
                                                                                          onclick="addProductToCart(this.id, '<?php echo $value['spec_value']; ?>','<?php echo $key; ?>', true)"
                                                                                    ><?php echo $value['spec_value']; ?></span>
                                                                                    <div class="pb-10">
                                                                                        <input type="button" value="-"
                                                                                               onclick="minusValue('<?php echo $url_title; ?>',this,'<?php echo $key; ?>', true,'<?php echo $i; ?>')"
                                                                                               class="minus" id="minus">
                                                                                        <input type="number"
                                                                                               id="currentItem_<?php echo $url_title; ?>"
                                                                                               onkeyup="addItemsWithSize('<?php echo $url_title; ?>',this,'<?php echo $key; ?>','', true, '0')"
                                                                                               value="0" title="Qty"
                                                                                               class="qty size-text-field"
                                                                                               size="4">
                                                                                        <input type="button"
                                                                                               onclick="plusValue('<?php echo $url_title; ?>',this,'<?php echo $key; ?>', true, '<?php echo $i; ?>')"
                                                                                               value="+" class="plus"
                                                                                               id="plus">
                                                                                    </div>
                                                                                <?php } ?>
                                                                            ...
                                                                            <dd class="sku-attr-val value util-clearfix">
                                                                                <?php foreach ($spec as $value) {
                                                                                    ...
                                                                                    <?php if ($j == 0) { ?>
                                                                                        <span class="text-frame sku-attr-val-frame"
                                                                                              id="currentItem_<?php echo $i; ?>"
                                                                                              onclick="addProductToCart(this.id, '<?php echo $value['spec_value']; ?>','<?php echo $key; ?>')"
                                                                                        ><?php echo $value['spec_value']; ?></span>
                                                                                    <?php } else { ?>
                                                                                        <div class="input-group pb-10">
                                                                                            <div style="width:50px"
                                                                                                 class="mr-10"
                                                                                                 title="<?php echo $value['spec_value']; ?>"><?php echo $value['spec_value']; ?></div>
                                                                                            <div>
                                                                                                <input <?= $disabled ?>
                                                                                                        type="button"
                                                                                                        value="-"
                                                                                                        onclick="minusValue('<?php echo $spec_under; ?>',this,'<?php echo $key; ?>')"
                                                                                                        class="minus"
                                                                                                        id="minus">
                                                                                                <input <?= $disabled ?>
                                                                                                        type="number"
                                                                                                        id="currentItem_<?php echo $spec_under; ?>"
                                                                                                        onkeyup="addItemsWithSize('<?php echo $spec_under; ?>',this,'<?php echo $key; ?>','','','<?php $i; ?>')"
                                                                                                        value="0"
                                                                                                        title="Qty"
                                                                                                        class="qty size-text-field"
                                                                                                        size="4">
                                                                                                <input <?= $disabled ?>
                                                                                                        type="button"
                                                                                                        onclick="plusValue('<?php echo $spec_under; ?>',this,'<?php echo $key; ?>')"
                                                                                                        value="+"
                                                                                                        class="plus"
                                                                                                        id="plus">
                                                                                            </div>
                                                                            ...
                                                                            <dd class="sku-attr-val value util-clearfix">
                                                                                <?php foreach ($spec as $value) {
                                                                                    ...
                                                                                    if ($j == 1) { ?>
                                                                                        <div class="input-group pb-10">
                                                                                            ...
                                                                                            <div>
                                                                                                <input type="button"
                                                                                                       value="-"
                                                                                                       onclick="minusValue('<?php echo $url_title; ?>',this,'<?php echo $key; ?>')"
                                                                                                       class="minus"
                                                                                                       id="minus">
                                                                                                <input type="number"
                                                                                                       id="currentItem_<?php echo $url_title; ?>"
                                                                                                       onkeyup="addItemsWithSize('<?php echo $url_title; ?>',this,'<?php echo $key; ?>','','','<?php echo $i; ?>')"
                                                                                                       value="0"
                                                                                                       title="Qty"
                                                                                                       class="qty size-text-field"
                                                                                                       size="4">
                                                                                                <input type="button"
                                                                                                       onclick="plusValue('<?php echo $url_title; ?>',this,'<?php echo $key; ?>')"
                                                                                                       value="+"
                                                                                                       class="plus"
                                                                                                       id="plus">
                                                                                            </div>
                                                                                    ...
                                                                                    if ($j > 1) { ?>
                                                                                        <span class="text-frame sku-attr-val-frame"
                                                                                              id="currentItem_<?php echo $i; ?>"
                                                                                              onclick="thirdSpec(this.id, '<?php echo $value['spec_value']; ?>','<?php echo $key; ?>')"
                                                                                        ><?php echo $value['spec_value']; ?></span>
                                                                                    <?php }
                                                                                } ?>
                                                                            </dd>
                                                                    ...
                                                                    <dd class="sku-attr-val value util-clearfix">
                                                                        <div class="quantity">
                                                                            <input type="button" value="-" class="minus"
                                                                                   id="minusNoSpec"
                                                                                   onclick="valueForNoSpecification('counterNoSpec', 'minus')">
                                                                            <input type="number" value="0" title="Qty"
                                                                                   class="qty"
                                                                                   size="4" id="counterNoSpec"
                                                                                   onkeyup="valueForNoSpecification('counterNoSpec', 'keyup')">
                                                                            <input type="button" value="+" class="plus"
                                                                                   id="plusNoSpec"
                                                                                   onclick="valueForNoSpecification('counterNoSpec', 'plus')">
                                                                        </div>
                                                                    </dd>
                                                                </dl>
                                                            </div>
                                                        ...
                                                        <div id="skuWrap" class="sku-wrap">
                                                            <div class="product-total-price">
                                                                <span class="mark-calculator-quantity"
                                                                      id="qnty"> 1 </span> <span
                                                                        class="mark-calculator-quantity"><?php echo $product_prices[0]['units_name']; ?></span>
                                                                selected
                                                                <br>
                                                                <span class="mark-calculator">
                                                                <i class="fa fa-inr"></i>&nbsp; <span
                                                                            id="price_count"><?php
                                                                        echo $product_prices[0]['final_price']; ?></span>
                                                                </span>in total
                                                                <button type="button" id="modelDetails"
                                                                        class="btn btn-info btn-sm pull-right"
                                                                        data-toggle="modal" data-target="#myModal"
                                                                        style="margin-top: -15px;">view Details
                                                                </button>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="ma-operate">
                                                ...
                                                <div class="ma-main-operate">
                                                    <?php if ($product["available_quantity"] <= 0) {
                                                        $hideTimer = true;//if product is out of stock then don't run timer
                                                        ?>
                                                        <div class="row">
                                                            <button class='ui2-button ui2-button-primary ui2-button-large placeorder dot-app-pd ui-button-buy'
                                                                    id="notify_buyer" <?php echo $class ?>
                                                                    data-id="<?php echo $product['id']; ?>">Notify Me
                                                            </button>
                                                            <?php echo "<p style='font-weight:bold;font-size:1.4em;' class='text-danger mb-2 ml-5 text-center'>Out Of Stock</p>";
                                                            ?>
                                                        </div>
                                                        <div class="row">
                                                            <p class="mt-1 text-center text-success"
                                                               id="notify-msg-success"><?php echo $msg; ?></p>
                                                        </div>
                                                    <?php } else { ?>
                                                        <a id="start_order" href="javascript:void(0)"
                                                           data-product-id="<?php echo $product['id']; ?>">
                                                            <button id="J-btn-order"
                                                                    class="ui2-button ui2-button-primary ui2-button-large placeorder dot-app-pd ui-button-buy ">
                                                                Start Order
                                                            </button>
                                                        </a>
                                                        <a href="<?php echo base_url(); ?>product-inquiry/<?php echo $product['id']; ?>">
                                                            <button id="J-btn-order"
                                                                    class="ui2-button ui2-button-primary ui2-button-large placeorder dot-app-pd ui-button-buy ">
                                                                Contact Supplier
                                                            </button>
                                                        ...
                                                        <?php if ($product['provide_order_at_buyer_place'] == 1) { ?>
                                                            <a href="javascript:void(0)"
                                                               ...
                                                               id="add_to_cart">
                                                                <button id="J-btn-order"
                                                                        class="ui2-button ui2-button-primary ui2-button-large placeorder dot-app-pd ui-button-buy my-btn ">
                                                                    Add to Cart
                                                                </button>
                                                            </a>
                                                        <?php } ?>
                                        ...
                                        <div data-reactroot="" class="details-assurance-educate" data-spm="taedu">
                                            <div class="ma-brief-list">
                                                <dl class="ma-brief-item">
                                                    <dt class="ma-brief-item-key" title="Seller Support:">Seller
                                                        Support:
                                                    </dt>
                                                ...
                                                <div class="_2KHWIh">
                                                    <div class="_29cQtz">
                                                        <img src="<?php echo base_url(); ?>assets/images/location.png"
                                                             class="_3KEg0q"><span class="_1nBnpg">Deliver to</span>
                                                    </div>
                                                    <div class="input-group">
                                                        <input type="hidden" class="pro_idd" value="<?php echo $product['seller']; ?>">
                                                        <input type="text" name="pincode"
                                                               placeholder="Enter delivery pincode" value=""
                                                               maxlength="6" autocomplete="off" class="_20PCkk pincode"
                                                               onkeyup="return restrictAlphabets(event)"
                                                               autocomplete="off">
                                                        <p id='tot_address'></p>
                                                        <!--<button class="btn btn-danger btn-sm check" id="Checkpincode">
                                                            Check
                                                        </button>-->
                                                    </div>
                                                    <div id="areacode"></div>
                            ...
                            <div class="details-info" id="J-ls-grid-desc">
                                ...
                                <div class="detail-box box-type-detailTab" data-module="detailTab">
                                    <div data-reactroot="" class="details-tab-wrapper" data-spm="tabs"
                                         style="height: auto;">
                                        <div></div>
                                                                ...
                                                                <div class="next-tabs-nav"
                                                                    ...
                                                                    <div role="tab" aria-disabled="false"
                                                                        ...
                                                                        <div class="next-tabs-tab-inner"
                                                                            ...
                                                                            <a class="tab-name" title="Product Details">Product
                                                                                Details</a>
                                                                        </div>
                                                                    </div>
                                                                    <div role="tab" aria-disabled="false"
                                                                        ...
                                                                        <div class="next-tabs-tab-inner"
                                                                             style="font-weight: bold;">
                                                                            <a class="tab-name" title="Company Profile">Company
                                                                                Profile</a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                ...
                                <div class="tab-body" data-role="detail-tab-body">
                                    <div class="tab-body-pane ls-icon ls-product show " id="one">
                                        <div class="ls-icon">
                                            <div class="detail-box">
                                                            ...
                                                            <div class="do-overview">
                                                                <div class="do-entry do-entry-separate">
                                                                    <div class="do-entry-title"
                                                                         style="text-indent:20px; font-size: 18px;">
                                                                        Quick Details
                                                                    </div>
                                                                            ...
                                                                            <dl class="do-entry-item">
                                                                                <dt class="do-entry-item">
                                                                                    <span class="attr-name J-attr-name"
                                                                                          title="Type"><?php echo $row['attribute_name']; ?>:</span>
                                                                                </dt>
                                                                                <dd class="do-entry-item-val">
                                                                                    <div class="ellipsis"
                                                                                         title="Dry Iron"><?php echo $row['attribute_value']; ?></div>
                                                                                </dd>
                                                                            </dl>
                                                                        </div>
                                                                    <?php } ?>
                                                ...
                                                <div class="scc-wrapper detail-module module-detailVideo"
                                                     data-spm="detailvideo">
                                                </div>
                                                <div class="scc-wrapper detail-module module-productSpecification"
                                                     data-spm="pronpeci14">
                                                    <!--false | 377944411-->
                                                    <style type="text/css">
                                                        .richtext [data-maya] {
                                                    ...
                                                    <div id="J-rich-text-description"
                                                         class="richtext richtext-detail rich-text-description">
                                                        <p><span style="font-size: 18px;"><strong><?php echo $product['name']; ?>
                                                        </strong></span>
                                                        </p>
                                                        <p>&nbsp;</p>
                                                        <p><span style="font-size: 18px;"><strong
                                                                        style="color:#000000;"><?php echo $product['description']; ?>
                                                        </strong></span>
                                                        </p>
                                                        <p>&nbsp;</p>
                                                        <p>
                                    ...
                                    <div class="tab-body-pane ls-icon ls-company" id="two">
                                        <div class="alisite" data-module="alisite" data-scene="companyProfile"
                                            ...
                                            <div class="J_module" module-name="icbu-pc-cpCompanyOverview"
                                                 module-title="cpCompanyOverview">
                                                <div data-reactroot=""
                                                     class="icbu-mod-wrapper with-round no-title icbu-pc-cpCompanyOverview v2">
                                                    <div class="wrap-box">
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <div class="content-value"
                                                                                         title="Trading Company"><?php echo $company->company_type; ?></div>
                                                                                </div>
                                                                        ...
                                                                        <td class="field-content-wrap">
                                                                            <div
                                                                                ...
                                                                                <div
                                                                                        style="overflow: hidden; text-overflow: ellipsis; -webkit-box-orient: vertical; display: -webkit-box; -webkit-line-clamp: 3;">
                                                                                    <div class="content-value"
                                                                                         title="<?php echo $company->comp_operational_addr; ?>">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="field-content-wrap">
                                                                            <div
                                                                                ...
                                                                                <div
                                                                                        style="overflow: hidden; text-overflow: ellipsis; -webkit-box-orient: vertical; display: -webkit-box; -webkit-line-clamp: 3;">
                                                                                    <a class="content-value" href="#"
                                                                                       data-spm-click=""><?php $main_prs = array_filter(json_decode($company->main_products));
                                                                                        foreach ($main_prs as $row) {
                                                                                            echo $row . ',';
                                                                                        } ?></a>
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <td class="field-content-wrap">
                                                                            <div
                                                                                ...
                                                                                <div
                                                                                        style="overflow: hidden; text-overflow: ellipsis; -webkit-box-orient: vertical; display: -webkit-box; -webkit-line-clamp: 3;">
                                                                                    <div class="content-value"
                                                                                         title="Fewer than 5 People"><?php echo $company->no_of_employee; ?></div>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="field-title">Total Annual Revenue
                                                                        </td>
                                                                        <td class="field-content-wrap">
                                                                            <div
                                                                                    class="next-row next-row-no-padding next-row-justify-space-between field-content">
                                                                        ...
                                                                        <td class="field-content-wrap">
                                                                            <div
                                                                                ...
                                                                                <div
                                                                                        style="overflow: hidden; text-overflow: ellipsis; -webkit-box-orient: vertical; display: -webkit-box; -webkit-line-clamp: 3;">
                                                                                    <div class="content-value"
                                                                                         title=""> <?php echo $company->honor_award_certifications; ?></div>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                        <td class="field-title">Product
                                                                            Certifications(4)
                                                                        </td>
                                                                        <td class="field-content-wrap">
                                                                            <div
                                                                        ...
                                                                        <td class="field-content-wrap">
                                                                            <div
                                                                                ...
                                                                                <div
                                                                                        style="overflow: hidden; text-overflow: ellipsis; -webkit-box-orient: vertical; display: -webkit-box; -webkit-line-clamp: 3;">
                                                                                    <div class="content-value"
                                                                                         title=""> <?php echo $company->patents; ?></div>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                        ...
                                                                        <td class="field-content-wrap">
                                                                            <div
                                                                                ...
                                                                                <div
                                                                                        style="overflow: hidden; text-overflow: ellipsis; -webkit-box-orient: vertical; display: -webkit-box; -webkit-line-clamp: 3;">
                                                                                    <div class="content-value"
                                                                                         title=""><?php echo $company->trademarks; ?></div>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                            ...
                                            <div class="J_module" module-name="icbu-pc-cpProductionCapacity"
                                                 module-title="cpProductionCapacity">
                                                <div data-reactroot="" class="icbu-pc-cpProductionCapacity">
                                                    <div class="icbu-mod-wrapper with-round icbu-infoList-mod v3"
                                                        ...
                                                        <div class="wrap-box">
                                                            ...
                                                            <div class="mod-content">
                                                                <div class="icbu-mod-viewMore infoList-mod-wrap"
                                            ...
                                            <div class="J_module" module-name="icbu-pc-cpTradeCapability"
                                            ...
                                            <div class="J_module" module-name="icbu-pc-cpKeyCustomers"
                                                 module-title="cpKeyCustomers">
                                                <!-- react-empty: 1 -->
                                            </div>
                                            <div class="J_module" module-name="icbu-pc-cpReports"
                                                 module-title="cpReports">
                                                <!-- react-empty: 1 -->
                                            </div>
                                        </div>
                                        <div class="cp-footer">
                                        ...
                                        <a class="link-default"
                                           href="<?php echo site_url(); ?>company-details/<?php echo $company->company_name; ?>"
                                    ...
                                    <div class="scc-wrapper detail-module module-companyCardIntegrated">
                                        ...
                                        >
                                            ...
                                            <div class="card-supplier">
                                                ...
                                                ?>
                                                <ul>
                                                    <li style="line-height:30px;"><strong> Registered Since
                                                            : <?php echo ($year_of_register != 0) ? $year_of_register : "1"; ?>
                                                            Yrs </strong></li>
                                                    <li style="line-height:30px;"><strong>Company Type
                                                            : <?php echo $product['business_type']; ?></strong></li>
                                                    <li style="line-height:30px;"><strong>Country
                                                            : <?php echo $product['country_name']; ?></strong></li>
                                                </ul>
                                            </div>
                                                ...
                                                if ($i <= 3) {
                                                    ...
                                                    <div class="product-item esite-clearfix">
                                                        ...
                                                        <div class="info pb-2">
                                                            ...
                                                            <div class="attr"
                                                                 title="<?php echo $rel_prod->final_price1; ?> - <?php echo $rel_prod->final_price2; ?> /<?php echo $rel_prod->units_name; ?>">
                                                                <span class="bold"><i
                                                                            class="fa fa-inr"></i>  <?php echo sprintf("%01.2f", $rel_prod->final_price1); ?></span> </br>
                                                                <span>
                                                                <?php
                                                                if ($rel_prod->mrp != $rel_prod->final_price1 && $rel_prod->mrp != 0) {
                                                                    if($rel_prod->discount != 0) {
                                                                        echo "<i class='fa fa-inr'></i> <span class='price-new text-mute'><del>" . sprintf("%01.2f", $rel_prod->mrp) . "</del></span> ";
                                                                        echo " <strong><span class='text-success'>" . $rel_prod->discount . "</span> </strong>";
                                                                    }
                                                                }
                                                                ?>
                                                                 </span>
                                    ...
                                    <div class="col-md-2">
                                        <figure class="card card-product">
                                            <div class="img-wrap"><a
                                                        href="<?php echo base_url(); ?>product-details/<?php echo $url_title; ?>/<?php echo $product->product_id; ?>"
                                                        target="_blank"> <img src="<?php echo $product->media_url; ?>"
                                                                              width="169px" height="169px"></a></div>
                                            <figcaption class="info-wrap">
                                                ...
                                                <div class="price-wrap">
                                                    <i class="fa fa-inr"></i> <span
                                                            class="price-new"><?php echo sprintf("%01.2f", $product->final_price1); ?></a></span>
                                                ...
                                                if ($product->mrp != $product->final_price1 && $product->mrp != 0) {
                                                    if($product->discount != 0) {
                                                        echo "<i class='fa fa-inr'></i> <span class='price-new text-mute'><del>" . sprintf("%01.2f", $product->mrp) . "</del></span> ";
...
<script>
    ...
    function createArrayNoSpec(uniqueId, colorkey, sizeKey, colorValue, quantity, itemSize, priceArray, unitsName, rowId, idForRowOnly) {
        ...
        var temparray = {
            ...
            'quantity': quantity,
            'size': itemSize,
            'unitPrice': priceArray.final_price,
            'unitsName': priceArray.units_name,
            'rowId': rowId,
            'idForRowOnly': idForRowOnly,
            'moq': moq
        };
    ...
    function thirdSpec(id, tSpec = '', key) {
        if ((totalQuantity == 0)) {
            ...
            if (id && tSpec && key) {
                ...
                var thirdspecArr = {
                    'thirdSpecValue': thirdSpecValue,
                    'thirdSpecKey': thirdSpecKey,
                    'currentId': currentId,
                    'isOther': true,
                    'uniqueIdThird': uniqueId
                };
    ...
    $('#add_to_cart').click(function () {
        ...
        if (totalQuantity > 0 && totalQuantity <= available_quantity && checkQuantityExist(totalQuantity) && finalObject.length > 0) {
            flyimage();
            $('#cart').show();
            var product_id = $(this).data('product-id');
            var offer_id = '<?php echo $offer_id; ?>';
            var t_quantity = totalQuantity;
            ...
            $.ajax({
                ...
                method: 'POST',
                dataType: 'json',
                data: {offer_id: offer_id, product_id: product_id, t_quantity: t_quantity, tempList: finalObject},
    ...
    $('#start_order').click(function (event) {
        ...
        if(totalQuantity > maxQuantity && maxQuantity !=0) {
            $('#display_error').html("Quantity should be at most left in-stock quantity");
            event.preventDefault();
            return false;
        }
        
        if ((totalQuantity == 0) || !checkQuantityExist(totalQuantity) ) {
            //((totalQuantity == 0) || !checkQuantityExist(totalQuantity) || totalQuantity > available_quantity)
            ...
            $.ajax({
                ...
                method: 'POST',
                dataType: 'json',
                data: {product_id: product_id, offer_id: offer_id, t_quantity: t_quantity, tempList: finalObject_with_dis},
                success: function (data) {
                    console.log(data);
                    if (data.status == 1) {
        ...
        if (cg_length == 6) {
            $.ajax({
                ...
                $("#areacode").html("<b style='color:red'>Sorry ! The Item is Not Deliverable at this Pincode.</b>");
                        ...
                        $("#areacode").html("<b style='color:green'>The Item is Deliverable at this Pincode (Expected Delivery In 3-5 Days).</b>");
                    } else {
                        $("#areacode").html("<b style='color:red'>Sorry ! The Item is Not Deliverable at this Pincode.</b>");
                    }
                }
            ...
            $("#areacode").html("<b style='color:red'>Enter Valid Pin Code</b>");
        }
    });
            ...
            $.post("<?php echo base_url('home_product/add_notify_buyer'); ?>",
                ...
                .done(function (data) {
                    if (data == 1) {
                        ...
                        $('#notify_buyer').attr("disabled", false);
                    }
                });
        });
    });
    ...
    $(document).ready(function () {
        ...
        function getCityState($zip, $blnUSA) {
            ...
            $.getJSON('https://maps.googleapis.com/maps/api/geocode/json?address=' + $zip + '&key=AIzaSyBkN0wRthzWGnY1ppnijgRhqVwkjY03Eko&type=json&_=' + date.getTime(), function (response) {
                ...
                if (hascity == 1) {
                    //$('#city').val(city);
                    tot_address = tot_address + ' ' + city;
                } else if (hassub == 1) {
                    $('#city').val(subloc);
                    tot_address = tot_address + ' ' + subloc;
                } else {
                    //$('#city').val(nbhd);
                    tot_address = tot_address + ' ' + nbhd;
                }
                tot_address = tot_address + ' ' + state;
                console.log(tot_address);
                //$('#state').val(state);
                $('#tot_address').html(tot_address);
                //reset
                var hascity = 0;
                var hassub = 0;
            });
...
<?php
if ($hideTimer === FALSE) { //start timer only if product is available in quantity
...
<script>
    ...
    var x = setInterval(function() {
        ...
        document.getElementById("offer_timer").innerHTML = 'Special price ends in less than '+days + "d " + hours + "h "
            + minutes + "m " + seconds + "s ";
