...
<script>
 ...
 gtag('config', 'AW-728750276');
   ...
   <body>
	...
	<div class="container" >
	   <form  action="<?php echo site_url();?>m/signin/reset_password" name="reset_pass"  method="post">
		<div class="row">
			<div class="col-lg-5 col-sm-12 mt-4">
				...
				<div class="">
				   <input type="password" name="txt_password" class="form-control" placeholder="Enter Your New Password" >
				   <div style="color:red" id="email_error"><?php echo form_error('txt_password'); ?></div>
				</div>
				</br>
				<div class="">
