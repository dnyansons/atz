...
<html>
    <head>
        <title>
            <?php echo urldecode($this->uri->segment(6)) ?? "Atzcart"; ?>
        </title>
        <meta charset="utf-8">
            ...
            <div class="master " clickevent="master" style="width:100%;">
                <div class="master-search">
                    <div class="search-bar flex ripple" clickevent="search" id="search_list">
                        <div class="text title"><?php echo urldecode($this->uri->segment(6));//echo $productlists[0]["categories_name"]; ?></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div view-type="gallery" class="list-refine" style-ready-trigger="" version="1.0.0" search-text="" cate-name=""
            ...
            <div class="section-title">
                <div class="search-result-title">
                    ...
                    <h1><b class="text-danger"><?php echo urldecode($this->uri->segment(6)); ?></b></h1>
                    products below
                </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="custom-control custom-radio">
                    <input type="radio" value="0" class="custom-control-input" id="defaultUnchecked" name="defaultExampleRadios" onChange="sortsmartsearchBy(this.value)" checked>
                    <label class="custom-control-label" for="defaultUnchecked">Price -- Low to High</label>
                </div>
                <div class="pt-2"></div>
                <!-- Default checked -->
                <div class="custom-control custom-radio">
                    <input type="radio" value="1" class="custom-control-input" id="defaultChecked" name="defaultExampleRadios" onChange="sortsmartsearchBy(this.value)">
        ...
        <div class="modal-content">      
            ...
            <div class="modal-body">
               <div class="filter-panel">
                   <div class="row m-0">
                        <div class="col-6">
                            <input type="text" name="min_price" id="min_price" value="" width="100px" class="form-control border text-center" placeholder=" &#8377 0.00" onkeyup="priceFilter()">
                        </div>
                        <div class="col-6">
                            <input type="text" name="max_price" id="max_price" v value="" width="100px" class="form-control border text-center" placeholder=" &#8377 0.00" onkeyup="priceFilter()">
                        </div>
                   </div>
                   <br/>
...
//    $_SESSION["recent"]=array("Apparel");
//    if(count($_SESSION['recent'])<6){
//        if(!in_array(urldecode($this->uri->segment(6)),$_SESSION["recent"]))
//        {
//          array_push($_SESSION["recent"],urldecode($this->uri->segment(6)));
//        }
//    }else{
//        array_push($_SESSION["recent"],urldecode($this->uri->segment(6)));
...
//    }
//}else{
//        $_SESSION["recent"]=urldecode($this->uri->segment(6)); 
//    }
...
<script>
    ...
    function sortsmartsearchBy(sort)
    {
        var type  = "<?php echo $this->uri->segment(3); ?>";
        var id  = "<?php echo $this->uri->segment(4); ?>";
        var parent_id  = "<?php echo $this->uri->segment(5); ?>";
        var term  = "<?php echo $this->uri->segment(6); ?>";
       
        $.ajax({
            url: '<?php echo site_url(); ?>m/search/sortsmartProducts',
            type: 'POST',
            dataType: "json",
            beforeSend: function ()
            {
            ...
            data: {sortby: sort,id:id,type:type,parent_id:parent_id,term:term},
...
function filterProducts() {
        ...
        $.ajax({
            ...
            url: '<?php echo site_url(); ?>m/search/sortsmartProducts',
            dataType: "json",
            data:{price_range:price_range,id:id,type:type,parent_id:parent_id,term:term},
            beforeSend: function () {
                $("#ai-product-list").html("");
                $("#loading").show();
            },
...
<script>
    ...
    $(document).ready(function () {
       ...
       *  When User Scroll Page Load Images lazy in Smart Search.
       */
        ...
        $.ajax({
            url: "<?php echo site_url(); ?>m/search/loadMoreData",
            type: "post",
            dataType:"json",
            data: {
                page:page,
