...
<html lang="en">
    ...
    <head>
        <title><?php if( isset($pageTitle)){echo $pageTitle;}else{ echo "Admin";}?></title>
        <!--[if lt IE 10]>
                                                                ...
                                                                <div class="card-block">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-sm-6">
                                                                            ...
                                                                            <h6 class="text-muted f-w-400"><a href="https://colorlib.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="28424d4651684f45494144064b4745">[email&#160;protected]</a></h6>
                                                                        </div>
                                                                        <div class="col-sm-6">
