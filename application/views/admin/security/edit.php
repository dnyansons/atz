					...
					<div class="col-lg-4">
						<div class="page-header-breadcrumb">
							<ul class="breadcrumb-title">
								...
								<li class="breadcrumb-item"><a href="<?php echo base_url();?>admin/security">List</a>
								</li>
						...
						<h4 class="sub-title">Security Questions</h4>
						 <form method="post" enctype="multipart/form-data">
							<div class="form-group row">
								...
								<div class="col-sm-10">
									<input type="text" name="questions" class="form-control" placeholder="Add Security Questions" value="<?php echo $result->questions; ?>" required>
								</div>
							</div>
