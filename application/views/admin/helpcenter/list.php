                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-header">
                                    ...
                                    <a href="<?php echo base_url(); ?>admin/helpCenter/addTitle">
...
<script>
    $(document).ready(function () {
        ...
        $.ajax({
            url: '<?php echo site_url("admin/helpCenter/ajax_list"); ?>',
            dataType: 'json',
            success: function (s) {
                console.log(s);
                oTable.fnClearTable();
                ...
                for (var i = 0; i < s.length; i++) {
                    ...
                    oTable.fnAddData([
                        ...
                        s[i]['parent_title'],
                        d + " " + m + " " + y,
                        '&nbsp;&nbsp;&nbsp;<a href="<?php echo base_url('admin/helpCenter/editTitles'); ?>/' + s[i]['id'] + '" class="tabledit-edit-button btn btn-primary waves-effect waves-light btn-sm" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"><i class="fa fa-pencil-square-o fa-2x"></i></a>',
                    ]);
                }
            },
            error: function (e) {
