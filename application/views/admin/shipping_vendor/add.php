                                ...
                                <div class="card-block">
                                    ...
                                    <form method="post" enctype="multipart/form-data">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="vendor_name" id="vendor_name" class="form-control" value="<?php echo set_value('vendor_name'); ?>">
...
<!--                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="contract_start_date" id="contract_start_date" class="form-control" value="<?php echo set_value('contract_start_date'); ?>">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="contract_end_date" id="contract_end_date" class="form-control" value="<?php echo set_value('contract_end_date'); ?>">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9 border-checkbox-section">
                                                <div class="border-checkbox-group border-checkbox-group-primary">
                                                    <input class="border-checkbox" type="checkbox" name="notify_me" id="checkbox1">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9 border-checkbox-section">
                                                <div class="border-checkbox-group border-checkbox-group-primary">
                                                    <input class="border-checkbox" type="checkbox" name="is_default" id="checkbox2">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="number" class="form-control" name="free_amount" id="free_amount" value="<?php echo set_value('free_amount'); ?>">
