                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-block">
                                    ...
                                    <form action = "<?php echo base_url(); ?>admin/report/exportProfitLossReport" method = "post" id="form_submit">
                                        <div class="row">
                                            <div class="col-md-12">
...
<script>
    $(document).ready(function () {
        var dtTable = $('#salesreport').DataTable({
            ...
            ajax: {
                url: "<?php echo base_url('admin/report/fetch_profitloss_report') ?>",
                dataType: "json",
                type: "POST",
                data: function (data) {
