                        ...
                        <div class="col-lg-4">
                            <div class="page-header-breadcrumb">
                                <ul class="breadcrumb-title">
									...
									<li class="breadcrumb-item">Non Settled Transaction</li>
                                </ul>
                            </div>
                        </div>
                    </div>
					...
					<div class="row">
                        <div class="col-md-12">
                            <div class="card">
								...
								<form action = "<?php echo base_url(); ?>admin/report/exportNonSettledReport" method = "post" id="form_submit">
                                    <div class="row">
										<div class="col-md-12">
...
<script>
    $(document).ready(function () {
       var dtTable =  $('#salesreport').DataTable({
            ...
            ajax: {
                url: "<?php echo base_url('admin/report/fetch_nonsettled_report') ?>",
                dataType: "json",
                type: "POST",
                data: function(data) {
