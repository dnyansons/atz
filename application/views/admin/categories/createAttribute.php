                        ...
                        <div class="col-lg-4">
                            <div class="page-header-breadcrumb">
                                <ul class="breadcrumb-title">
                                    ...
                                    <li class="breadcrumb-item"><a href="#">Add Attribute</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-8">
                            <div class="card">
                                ...
                                <div class="card-block">
                                    ...
                                    <form method="post" enctype="multipart/form-data" action="<?php echo site_url();?>admin/categories/createAttribute/<?php echo $cat_id;?>">
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">Name</label>
                                            <div class="col-sm-10">
                                                <input type="text" name="name" id="name" class="form-control" placeholder="Attribute Name" onkeypress="return restrictAlphabets(event)">
                                            </div>
                                        </div>
                                        <div class="form-group row">
