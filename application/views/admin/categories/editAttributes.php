                        ...
                        <div class="col-lg-4">
                            <div class="page-header-breadcrumb">
                                <ul class="breadcrumb-title">
                                    ...
                                    <li class="breadcrumb-item"><a href="#">Edit Attributes</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-8">
                            <div class="card">
                                ...
                                <div class="card-block">
                                    ...
                                    <form method="post" enctype="multipart/form-data" action="<?php echo site_url();?>admin/categories/editAttrs/<?php echo $attr_id;?>">
