                                    ...
                                    <form action="<?php echo site_url(); ?>admin/offer/updateoffer/<?php echo $offer_data['offer_id']; ?>" method="post" enctype='multipart/form-data' name="offer_form" >
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-5">
                                                <div class="input-group date">
                                                    <input type="text" name="valid_from" id="valid_from" class="form-control date" placeholder="yyyy-mm-dd" data-format="yyyy-mm-dd" readonly="readonly" value="<?php echo $offer_data['valid_from']; ?>" >
                                            ...
                                            <div class='col-sm-5'>
                                                <div class='input-group datetimepicker'>
                                                    <input type='text' name="time_from" value="<?php echo $offer_data['time_from']; ?>" class="form-control" />
                                                    <div class="input-group-addon">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-5">
                                                ...
                                                <div class="input-group date">
                                                    <input type="text" name="valid_to" id="valid_to" class="form-control date" placeholder="yyyy-mm-dd" data-format="yyyy-mm-dd" readonly="readonly" value="<?php echo $offer_data['valid_to']; ?>" >
                                                    <div class="input-group-addon">
                                                        <span class="fa fa-calendar"></span>
                                                    </div>
