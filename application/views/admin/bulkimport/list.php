                            ...
                            <div class="page-header-breadcrumb">
                                <ul class="breadcrumb-title">
                                    <li class="breadcrumb-item">
                                        <a href="<?php echo site_url(); ?>admin/bulkimport"> <i class="feather icon-home"></i> </a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="#">Bulk Products List</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <a class="btn btn-success btn-sm pull-right" href="<?php echo base_url(); ?>admin/bulkimport/import">Import File</a><a class="btn btn-info btn-sm pull-right mr-2" href="<?php echo base_url(); ?>uploads/sheets/products/sample_upload.xlsx">Sample Data</a>
                                </div>
                                <div class="card-block">
...
<script>
    $(document).ready(function () {
        var dtTable = $('#salesreport').DataTable({
            ...
            ajax: {
                url: "<?php echo base_url('admin/bulkimport/fetch_bulkimport') ?>",
                dataType: "json",
                type: "POST",
                data: function (data) {
