                                ...
                                <div class="card-block">
                                    <div class="">
                                        <div class="col-md-12 offset-1">
                                            ...
                                            <form
                                                action="<?php echo base_url('admin/sms_receivers/submit_receivers') ?>"
                                                method="post">
                                                <div class="form-group row">
                                                    <label for="emp_name">Employee Name : &nbsp;</label>
                                                    <input type="text" value="<?php echo set_value('emp_name'); ?>"
                                                        class="ml-4 form-control col-md-4 text-capitalize" name="emp_name"
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <input type="text" maxlength="10"
                                                        value="<?php echo set_value('emp_mobile'); ?>"
                                                        class="ml-4 form-control col-md-4" id="emp_mobile"
                                                        name="emp_mobile">
                                                </div>
                                                <span class=" row text-danger">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <select class="ml-4 form-control col-md-4" name="sms_for">
                                                        ...
                                                        <option value="Order Cancel"
                                                            <?php echo (set_value('sms_for') == 'Order Cancel') ? 'selected' : ''; ?>>
                                                            Order Cancel</option>
                                                        <option value="Order Processed"
                                                            <?php echo (set_value('sms_for') == 'Order Processed') ? 'selected' : ''; ?>>
                                                            Order Processed</option>
                                                        <option value="Order Delivered"
                                                            <?php echo (set_value('sms_for') == 'Order Delivered') ? 'selected' : ''; ?>>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <select class="form-control col-md-4" name="status">
                                                        ...
                                                        <option value="active"
                                                            <?php echo (set_value('status') == 'active') ? 'selected' : ''; ?>>
                                                            Active</option>
                                                        <option value="inactive"
                                                            <?php echo (set_value('status') == 'inactive') ? 'selected' : ''; ?>>
                                                            Inactive</option>
                                                    </select>
                                                </div>
                                                <span class=" row text-danger">
                                                ...
                                                <div class="col-md-12 offset-3">
                                                    <button type="submit" name="submit"
                                                        class=" btn btn-submit btn-danger" style="margin-left: -65px">
                                                        Submit
                                                    </button>
