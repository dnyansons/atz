                        ...
                        <div class="col-lg-4">
                            <div class="page-header-breadcrumb">
                                <ul class="breadcrumb-title">
                                    ...
                                    <li class="breadcrumb-item"><a href="<?php echo base_url('admin/BI/data_reports');?>">Recommended</a></li>
                                    <li class="breadcrumb-item">Add Data Report</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="page-body">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card">
                                ...
                                <div class="card-block">
                                    <h4 class="sub-title">Data Report</h4>
				        ...
				        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="topic" id="topic" class="form-control" placeholder="Topic" value="<?php echo set_value('topic');?>" required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
					...
					<div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea class="form-control" name="over_view" id="over_view" required><?php echo set_value('over_view');?></textarea>
                                            </div>
                                        </div>
					<div class="form-group row">
