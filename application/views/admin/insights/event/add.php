                ...
                <div class="page-body">
                    <div class="row">
				        ...
				        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="title" id="title" class="form-control"  value="<?php echo set_value('title');?>" minlength="10" maxlength="60"required>
                                            </div>
                                        </div>
                                         <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">You Tube Embed URL : </label>
                                            <div class="col-sm-10">
                                                <input type="url" name="you_tube_embed_url" id="you_tube_embed_url" class="form-control"  value="<?php echo set_value('you_tube_embed_url');?>" required>
                                            </div>
                                        </div>
                                         <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea name="short_description" class="form-control" rows="6" minlength="10" maxlength="100"><?php echo set_value('short_description');?></textarea>
                                            </div>
                                        </div>
