                ...
                <div class="page-body">
                    <div class="row ">
                        <div class="col-md-12 float-right">
                            <?php if ($ProductDetails_data['publish_status'] == 'rejected') { ?>
                                <a class="btn btn-sm btn-success m-1 ml-3 p-1 float-right"
                                   href="<?php echo base_url('admin/products/toggleActivation/approved/' . $ProductDetails_data['id']); ?>">
                                    <b>Activate Product</b>
                                </a>
                            <?php } else { ?>
                                <a class="btn btn-sm btn-danger m-1 ml-3 p-1 float-right"
                                   href="<?php echo base_url('admin/products/toggleActivation/rejected/' . $ProductDetails_data['id']); ?>">
                                    <b>Deactivate Product</b>
                                </a>
                            <?php } ?>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card social-tabs">
                                <ul class="nav nav-tabs md-tabs tab-timeline" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link" href="#basics" role="tab" aria-expanded="false">BASICS</a>

                                        <div class="slide"></div>
                                    </li>
                                     <li class="nav-item">
                                        <a class="nav-link" href="#basics" role="tab" aria-expanded="false">SEO ATTRIBUTES</a>

                                        <div class="slide"></div>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="#basics" role="tab" aria-expanded="false">PRODUCT ATTRIBUTES</a>
                            ...
                            <form
                                    action="<?php echo site_url(); ?>admin/products/update/<?php echo $hidden_product_id; ?>"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                ?>
                                                <a href="<?php echo base_url('admin/products/update_category/' . $hidden_product_id); ?>"
                                        ...
                                        <div class="form-group row">
                                            <label class="contol-label col-md-2">Product Name <span
                                                        class="text-danger">*</span></label>
                                            <div class="col-md-6">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="sub-title">SEO Attributes</h4>
                                        <div class="form-group row">
                                            <label class="contol-label col-md-2">Meta Keywords <span
                                                        class="text-danger">*</span></label>
                                            <div class="col-md-6">
                                                <input type="text" name="product_keywords" class="form-control"
                                                       maxlength="128" placeholder="Please fill in keywords with correct format: 'modifier words + product name + application scenario',
                                        ...
                                        <div class="form-group row">
                                            <label class="contol-label col-md-2">Meta Desciption </label>
                                            <div class="col-md-6">
                                                <input type="text" name="meta_desc" class="form-control"
                                                       value="<?= $ProductDetails_data['meta_description'] ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="contol-label col-md-2"> Meta Title </label>
                                            <div class="col-md-6">
                                                <input type="text" name="meta_title" class="form-control"
                                                       value="<?= $ProductDetails_data['meta_title'] ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="contol-label col-md-2">sURL </label>
                                            <div class="col-md-6">
                                                <input type="text" name="surl" class="form-control"
                                                       value="<?= $ProductDetails_data['surl'] ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-6">
                                                    <?php if ($attr->type == "single_input") { ?>
                                                        ...
                                                        <?php
                                                    } else if ($attr->type == "multi_checkbox") {
                                                        $options = json_decode($attr->choices);
                                                        ?>
                                                ...
                                                <div class="col-md-6 <?php echo $class; ?>">
                                                    <?php if ($spec->type == "single_input") { ?>
                                                        ...
                                                        <input type="hidden" class="form-control"
                                                               value="<?php echo $spec->id; ?>" name="spec_val_hidden[]"
                                                            <?php echo $required; ?>>
                                                        <?php
                                                        ...
                                                        <div class="form-group row cloneme"
                                                            ...
                                                            for ($i = 0; $i < $showOptionsCount; $i++) {
                                                                ...
                                                                <div class="col-md-10 mt-1" id="<?php echo $divNum; ?>">
                                                                    ...
                                                                    <select class="form-control " name="spec_val[]"
                                                                        <?php echo $required; ?>>
                                                                        <option value="">Select option</option>
                                                                        <?php foreach ($options as $option) {
                                                        ...
                                                        <?php echo $data_id; ?>
                                                                ...
                                                                <?php } else { ?>
                                                                    <div class="col-md-2"
                                                                         id="parentDiv<?php echo $divNum ?>">
                                                                        <button type="button"
                                                                                id="btn<?php echo $divNum; ?>"
                                                        ...
                                                        <?php
                                                    } else if ($spec->type == "multi_checkbox") {
                                                        $options = json_decode($spec->choices);
                                                        ?>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <label>
                                                    <input type="radio" value="1" name="buyers_place"
                                                        <?php echo $ProductDetails_data['provide_order_at_buyer_place'] == "1" ? "checked=checked" : ""; ?>>
                                                    Yes
                                                    <input type="radio" value="0" name="buyers_place"
                                                        <?php echo $ProductDetails_data['provide_order_at_buyer_place'] == "0" ? "checked=checked" : ""; ?>>
                                                    No
                                                </label>
...
<!--                                        </div>-->
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <label>
                                                    <input type="radio" value="Yes" name="is_product_returnable"
                                                        <?= $ProductDetails_data['is_product_returnable'] == "Yes" ? "checked=checked" : "" ?>>
                                                    Yes
                                                    <input type="radio" value="No" name="is_product_returnable"
                                                        <?= $ProductDetails_data['is_product_returnable'] == "No" ? "checked=checked" : "" ?>>
                                                    No
                                                </label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            <label class="contol-label col-md-2">Set price hike percentage</label>
                                            <div class="col-md-6">

                                                <select name="hike_percentage" id="hike_percentage" class="form-control"
                                                        onchange="hike_price(this.value);">
                                                    <?php
                                                    for ($i = 0; $i <= 100; $i++) {
                                                        if ($ProductDetails_data['hike_percentage'] == $i) {
                                                            echo "<option value='$i' selected='selected'>$i%</option>";
                                                        } else {
                                                            echo "<option value='$i'>$i%</option>";
                                                        }
                                        ...
                                        <div class="form-group row">
                                            <label class="contol-label col-md-2">Set price discount percentage</label>
                                            <div class="col-md-6">

                                                <select name="discount_percentage" id="discount_percentage"
                                                        class="form-control" onchange="discount_price(this.value);">
                                                    <?php
                                                    for ($i = 0; $i <= 100; $i++) {
                                                        if ($ProductDetails_data['discount_percentage'] == $i) {
                                                            echo "<option value='$i' selected='selected'>$i%</option>";
                                                        } else {
                                                            echo "<option value='$i'>$i%</option>";
                                                        }
                                            ...
                                            <div class="col-md-6">
                                                <label>
                                                    <input type="radio" class="price_type" value="single"
                                                           name="price_type"
                                                        <?php echo $ProductDetails_data['price_type'] == "single" ? "checked=checked" : ""; ?> data-toggle="tooltip" data-placement="top" title="Set Price Per Unit Quantity">
                                                    Single
                                                    <input type="radio" class="price_type" value="uniform"
                                                           name="price_type"
                                                        <?php echo $ProductDetails_data['price_type'] == "uniform" ? "checked=checked" : ""; ?> data-toggle="tooltip" data-placement="top" title="Set Multiple Price on Product's Minimum Order Quantity Ranges"     >
                                                    Uniform
                                                </label>
                                            </div>
                                        </div>
                                                    ...
                                                    <?php foreach ($units as $unit): ?>
                                                        ...
                                                        <?php if ($ProductDetails_data['product_prices'][0]->units_id == $unit->units_id) { ?>
                                                            ...
                                                            <option value="<?php echo $unit->units_id; ?>"
                                                                    selected="selected">
                                                                <?php echo $unit->units_name; ?></option>
                                        ...
                                        <div class="row">
                                            ...
                                            <label class="control-label col-md-2">Seller Price</label>
                                            <label class="control-label col-md-2">Hike Price</label>
                                            <label class="control-label col-md-2">Discount / Final Price</label>
                                        </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-2">
                                                    <input type="text" class="form-control" name="moq[]" id="moq_11"
                                                           ...
                                                           value="<?php echo set_value('moq[0]', $ProductDetails_data['product_prices'][0]->quantity_from); ?>"
                                                        <?= $disable_single; ?>>
                                                </div>
                                                <div class="col-md-2">
                                                    <input type="text" class="form-control" name="price[]" id="price_11"
                                                           placeholder="price per unit"
                                                           value="<?php echo set_value('price[0]', $ProductDetails_data['product_prices'][0]->price); ?>"
                                                        <?= $disable_single; ?>>
                                                </div>
                                                <div class="col-md-2">
                                                    <input type="text" class="form-control" name="hike_price[]"
                                                           id="hike_price_11" readonly=""
                                                           placeholder="hiked price per unit"
                                                           value="<?php echo set_value('hike_price[0]', $ProductDetails_data['product_prices'][0]->atz_price); ?>">
                                                </div>
                                                <div class="col-md-2">

                                                    <input type="text" class="form-control" name="discount_price[]"
                                                           id="discount_price_11" readonly=""
                                                           placeholder="discounted final price per unit"
                                                           value="<?php echo set_value('discount_price[0]', $ProductDetails_data['product_prices'][0]->final_price); ?>">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-2">
                                                    <input type="text" class="form-control" name="price[]" id="price_1"
                                                           placeholder="price per unit"
                                                           value="<?php echo $ProductDetails_data['product_prices'][0]->price; ?>"
                                                        <?= $disable_uniform; ?>>
                                                </div>
                                                <div class="col-md-2">
                                                    <input type="text" class="form-control" name="hike_price[]"
                                                           id="hike_price_1" placeholder="hiked price per unit"
                                                           value="<?php echo $ProductDetails_data['product_prices'][0]->atz_price; ?>"
                                                        <?= $disable_uniform; ?>>
                                                </div>
                                                <div class="col-md-2">
                                                    ...
                                                    <input type="text" class="form-control" name="discount_price[]"
                                                           id="discount_price_1"
                                                           placeholder="discounted final price per unit"
                                                           value="<?php echo $ProductDetails_data['product_prices'][0]->final_price; ?>"
                                                        <?= $disable_uniform; ?>>
                                                ...
                                                <div class="col-md-2">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" name="moq[]" id="moq_2"
                                                               placeholder="Minimum order quantity"
                                                               value="<?php echo $ProductDetails_data['product_prices'][1]->quantity_from; ?>"
                                                            <?= $disable_uniform; ?>>
                                                    </div>
                                                </div>
                                                <div class="col-md-2">
                                                    <input type="text" class="form-control" name="price[]" id="price_2"
                                                           placeholder="price per unit"
                                                           value="<?php echo $ProductDetails_data['product_prices'][1]->price; ?>"
                                                        <?= $disable_uniform; ?>>
                                                </div>
                                                <div class="col-md-2">
                                                    <input type="text" class="form-control" name="hike_price[]"
                                                           id="hike_price_2" placeholder="hiked price per unit"
                                                           value="<?php echo $ProductDetails_data['product_prices'][1]->atz_price; ?>"
                                                        <?= $disable_uniform; ?>>
                                                </div>
                                                <div class="col-md-2">
                                                    ...
                                                    <input type="text" class="form-control" name="discount_price[]"
                                                           id="discount_price_2"
                                                           placeholder="discounted final price per unit"
                                                           value="<?php echo $ProductDetails_data['product_prices'][1]->final_price; ?>"
                                                        <?= $disable_uniform; ?>>
                                                ...
                                                <div class="col-md-2">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" name="moq[]" id="moq_3"
                                                               placeholder="Minimum order quantity"
                                                               value="<?php echo $ProductDetails_data['product_prices'][2]->quantity_from; ?>"
                                                            <?= $disable_uniform; ?>>
                                                    </div>
                                                </div>
                                                <div class="col-md-2">
                                                    <input type="text" class="form-control" name="price[]" id="price_3"
                                                           placeholder="price per unit"
                                                           value="<?php echo $ProductDetails_data['product_prices'][2]->price; ?>"
                                                        <?= $disable_uniform; ?>>
                                                </div>
                                                <div class="col-md-2">
                                                    <input type="text" class="form-control" name="hike_price[]"
                                                           id="hike_price_3" placeholder="hiked price per unit"
                                                           value="<?php echo $ProductDetails_data['product_prices'][2]->atz_price; ?>"
                                                        <?= $disable_uniform; ?>>
                                                </div>
                                                <div class="col-md-2">
                                                    <input type="text" class="form-control" name="discount_price[]"
                                                           id="discount_price_3"
                                                           placeholder="discounted final price per unit"
                                                           value="<?php echo $ProductDetails_data['product_prices'][2]->final_price; ?>"
                                                        <?= $disable_uniform; ?>>
                                                ...
                                                <div class="col-md-2">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" name="moq[]" id="moq_4"
                                                               placeholder="Minimum order quantity"
                                                               value="<?php echo $ProductDetails_data['product_prices'][3]->quantity_from; ?>"
                                                            <?= $disable_uniform; ?>>
                                                    </div>
                                                </div>
                                                <div class="col-md-2">
                                                    <input type="text" class="form-control" name="price[]" id="price_4"
                                                           placeholder="price per unit"
                                                           value="<?php echo $ProductDetails_data['product_prices'][3]->price; ?>"
                                                        <?= $disable_uniform; ?>>
                                                </div>
                                                <div class="col-md-2">
                                                    <input type="text" class="form-control" name="hike_price[]"
                                                           id="hike_price_4" placeholder="hiked price per unit"
                                                           value="<?php echo $ProductDetails_data['product_prices'][3]->atz_price; ?>"
                                                        <?= $disable_uniform; ?>>
                                                </div>
                                                <div class="col-md-2">
                                                    ...
                                                    <input type="text" class="form-control" name="discount_price[]"
                                                           id="discount_price_4"
                                                           placeholder="discounted final price per unit"
                                                           value="<?php echo $ProductDetails_data['product_prices'][3]->final_price; ?>"
                                                        <?= $disable_uniform; ?>>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                ...
                                                <table id="images"
                                                    ...
                                                    <tbody>
                                                    <?php
                                                    if (isset($ProductDetails_data['images'])) {
                                                        $img_count = 0;
                                                        foreach ($ProductDetails_data['images'] as $imgd) {
                                                            ?>

                                                            <?php
                                                            //$img_array=explode('.', $imgd);
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-right">
                                                            <button type="button"
                                                                    onclick="addImage();" data-toggle="tooltip" title=""
                                                                    class="btn btn-primary"
                                            ...
                                            <div class="col-md-10">
                                                ...
                                                <table id="video"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <iframe width="200" height="100" src=""
                                                                    id="youtube_video" frameborder="0"
...
<script type="text/javascript">
    ...
    function addImage() {
        ...
        html += '  <td class="text-left"><img src="#" id="product_image_show' + image_row +
            '" alt="No Image" title="" /></td>';
        html += '  <td class="text-left"><input type="file" name="product_image_file[]" onchange="readImageURL(this, ' +
            image_row + ');" onclick="resetImage(this, ' + image_row +
            ')" class="file"><input type="hidden" name="product_hidden_image_file[]" id="hidden_img' + image_row +
            '" value=""><span id="uploadmsg' + image_row + '"></span></td>';
        html += '  <td class="text-right"><button type="button" onclick="$(\'#image-row' + image_row +
...
<script type="text/javascript">
    //function to change values using hike and discount values
    $(document).ready(function () {
        var hikeByValue = $('#hike_percentage').val();
        var discountByValue = $('#discount_percentage').val();
        $('#price_11, #price_1, #price_2, #price_3, #price_4').change(
            function () {
                hike_price(hikeByValue);
                discount_price(discountByValue);
            });
    });


    function hike_price(percentage) {
        var price_type = $("input[name='price_type']:checked").val();
        var percentage = parseInt(percentage);

        if (price_type == "single") {
            var price_11 = parseInt($("#price_11").val());
            price_11 = ((price_11 * percentage) / 100) + price_11;
            $("#hike_price_11").val(price_11);
        } else if (price_type == "uniform") {
            var price_1 = parseInt($("#price_1").val());
            var price_2 = parseInt($("#price_2").val());
            var price_3 = parseInt($("#price_3").val());
            var price_4 = parseInt($("#price_4").val());

            price_1 = ((price_1 * percentage) / 100) + price_1;
            price_2 = ((price_2 * percentage) / 100) + price_2;
            price_3 = ((price_3 * percentage) / 100) + price_3;
            price_4 = ((price_4 * percentage) / 100) + price_4;

            $("#hike_price_1").val(price_1);
            $("#hike_price_2").val(price_2);
            $("#hike_price_3").val(price_3);
            $("#hike_price_4").val(price_4);
        }

        discount_price(document.getElementById('discount_percentage').value);
    }


    function discount_price(percentage) {
        var price_type = $("input[name='price_type']:checked").val();
        var percentage = parseInt(percentage);

        if (price_type == "single") {
            var hiked_price_11 = parseInt($("#hike_price_11").val());
            var discount_price_11 = hiked_price_11 - ((hiked_price_11 * percentage) / 100);
            $("#discount_price_11").val(discount_price_11);
        } else if (price_type == "uniform") {
            var hiked_price_1 = parseInt($("#hike_price_1").val());
            var discount_price_1 = hiked_price_1 - ((hiked_price_1 * percentage) / 100);

            var hiked_price_2 = parseInt($("#hike_price_2").val());
            var discount_price_2 = hiked_price_2 - ((hiked_price_2 * percentage) / 100);

            var hiked_price_3 = parseInt($("#hike_price_3").val());
            var discount_price_3 = hiked_price_3 - ((hiked_price_3 * percentage) / 100);

            var hiked_price_4 = parseInt($("#hike_price_4").val());
            var discount_price_4 = hiked_price_4 - ((hiked_price_4 * percentage) / 100);


            $("#discount_price_1").val(discount_price_1);
            $("#discount_price_2").val(discount_price_2);
            $("#discount_price_3").val(discount_price_3);
            $("#discount_price_4").val(discount_price_4);
        }
...
<script type="text/javascript">
    ...
    function addReturnPolicy() {
        ...
        if (policy_count <= 5) {
            ...
            html += '  <td class="text-left"><textarea name="policy[]" id="product_policy' + policy_row +
                '"  class="form-control policy"></textarea></td>';
            html += '  <td class="text-right"><button type="button" onclick="$(\'#policy-row' + policy_row +
                '\').remove();" data-toggle="tooltip" title="Remove" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button></td>';
            html += '</tr>';
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $('#moq_11, #moq_1, #moq_2, #moq_3, #moq_4, #price_1, #price_2, #price_3, #price_4, #price_11, #available_quantity, #low_stock_quantity').keydown(function (event) {
    ...
    function addSpecs(value) {
        ...
        $addHtml = '<div class="col-md-10 mt-1" id="' + newAddedListId + '">' +
            htmlSelectList +
            '</div><div class="col-md-2" id="parentDiv' + newAddedListId + '"><button type="button" id="btn' + newAddedListId +
            '" class="btn btn-sm btn_clone_spec_color mt-1" onclick=removeSpecs("' + newAddedListId + '")>' +
    ...
    function removeSpecs(value) {
        ...
        document.getElementById('parentDiv' + value).remove();
