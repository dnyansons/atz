                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <select id="orderstatus" class="form-control" name="orderstatus">
                                                    ...
                                                    <?php foreach ($statuses as $stat) { ?>
                                                        ...
                                                        <?php if ($order_status == $stat['orders_status_id']) { ?>
                                                            <option value="<?php echo $stat['orders_status_id']; ?>"
                                                                    selected><?php echo $stat['orders_status_name']; ?></option>
                                                        <?php } else { ?>
                                            ...
                                            if ($total_orders) {
                                                foreach ($total_orders as $ord) {
                                                    ...
                                                    <tr>
                                                        <td>
                                                            ...
                                                            if ($ord['order_token_number'] != 0 && $ord['awb_number'] == 0) {
                                                                ...
                                                                <a href="<?php echo base_url(); ?>admin/order/generate_waybill/<?php echo $ord['ord']; ?>"
                                                                   ...
                                                                   <?php
                                                            } elseif ((!empty($ord['awb']))&& (!empty($ord['awb_url']))&& $ord['ship_vendor_id']==2) {
                                                                ?>
                                                                <a href="<?php echo $ord['awb_url']; ?>" 
                                                                   class="badge badge-success">Download Way Bill</a>
                                                               
                                                                <?php
                                                            } elseif ($ord['awb_number'] != 0) {
                                                                 $bpath='https://'.$this->config->item("bucket").'.s3.ap-south-1.amazonaws.com/';
                                                                ?>
                                                                <a href="<?php echo $bpath; ?>uploads/wayBill_generate/waybill_<?php echo $ord['ord']; ?>.pdf"
                                                                   class="badge badge-success">Download Way Bill</a>
                                                                <?php
                                                            } else {
                                                        ...
                                                        <td><?php 
                                                        if($ord['ship_vendor_id']==2){
                                                            echo 'Ship Rocket';
                                                        }else{
                                                            echo 'Blue Dart';
                                                        }
                                                         ?></td>
                                                        <td><?php echo $ord['shippment_type']; ?></td>
...
<script>
    $(document).ready(function () {
        ...
        $(document).on('click', '#btnFilter', function () {
            var formAction = '<?php echo base_url(); ?>admin/order/show';
            //set form action
            $('#submit_form').attr('action', formAction);
            //submit form
            $('#submit_form').submit();
