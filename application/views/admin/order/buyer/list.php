                        ...
                        <div class="col-lg-4">
                            <div class="page-header-breadcrumb">
                                <ul class="breadcrumb-title">
                                    ...
                                    <li class="breadcrumb-item"><a href="#">My Order List <?php echo $user_id; ?></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
...
function view_product(ch)
	   {
		  $.ajax({
						type:'POST',
						url :'<?php echo base_url(); ?>user/myorders/order_view',
						data: {'order_id':ch},
...
function view_review(products_id)
	   {
		 ...
		 $.ajax({
						type:'POST',
						url :'<?php echo base_url(); ?>user/myorders/review_view',
