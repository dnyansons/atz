                        ...
                        <div class="col-lg-4">
                            <div class="page-header-breadcrumb">
                                <ul class="breadcrumb-title">
                                    ...
                                    <li class="breadcrumb-item"><a href="#!">Add Tax Class</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <form method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="col-sm-10">
                                                <select name="categories_id" class="form-control">
                                                    ...
                                                    <?php foreach($categories_list as $category){ 
                                                        ...
                                                        if($cat->category_id==$tax_class_data->categories_id)
                                                        {
                                       ...
                                       <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="tax_class_title" id="tax_class_title" class="form-control" placeholder="Tax Class Name">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="tax_class_rate" id="tax_class_rate" class="form-control" placeholder="Tax Class Rate">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea name="tax_class_description" class="form-control ckeditor"></textarea>
                                            </div>
                                        </div>
