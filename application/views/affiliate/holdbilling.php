                                    ...
                                    <form method="post" id="form_submit">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-3">
                                                ...
                                                <input type="text" name="totalCount" class="form-control" value="<?php echo $result->totalorder; ?>" readonly="readonly">
                                            </div>
                                            <div class="col-sm-3">
                                                <label class=" col-form-label"><strong>Billing Amount rs.</strong></label>
                                                <input type="text" name="billingAmount" class="form-control" value="<?php echo $result->amount;; ?>" readonly="readonly">
                                                <input type="hidden" name="billingId" class="form-control" value="<?php echo $billingId; ?>" readonly="readonly">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-3">
                                                <input type="text" name="referenceId" id="referenceId" class="form-control" value="<?php echo set_value("referenceId"); ?>" placeholder="Reference #" required>
                                                <?php echo form_error("referenceId");?>
                                            </div>
                                            <div class="col-sm-3">
                                                <input type="text" name="paymentDate" id="paymentDate" class="form-control"  id="date" value="<?php echo set_value("paymentDate"); ?>" placeholder="Payment Date" required>
