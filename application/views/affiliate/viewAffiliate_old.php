                            ...
                            <div class="card">
                                ...
                                <div class="card-block">
                                    ...
                                    <form method="post">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">Affiliate Program Url</label>
                                            <div class="col-sm-10">
                                         ...
                                         <?php if($affiliateData->status == "Pending" || $affiliateData->status == "Rejected"){ ?>
                                            ...
                                            <div class="form-group row">
                                                <label class="col-sm-2 col-form-label">Per Order Click</label>
                                                <div class="col-sm-10">
                                        ...
                                        <?php } else { ?>
                                            <div class="form-group row">
                                                <label class="col-sm-2 col-form-label">Rate</label>
                                                <div class="col-sm-10">
                                                    <input type="text" name="rate" class="form-control" value="<?php echo $affiliateData->rate; ?> " readonly="readonly">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-sm-2 col-form-label">Rate Per Order</label>
                                                <div class="col-sm-10">
