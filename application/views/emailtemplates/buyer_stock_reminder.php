    ...
    <head>
        ...
        <style type="text/css" media="screen">
            ...
            .button-style {
                ...
                font-weight: 500;
                background:#bd081b; color:#fff !important;
            }
                                                ...
                                                <table cellpadding="0" cellspacing="0" width="100%" bgcolor="#ffffff">
                                                    ...
                                                    <tr>
                                                        <td valign="top" style="padding-bottom:20px; background-color:#ffffff;">
                                                            <b>Hello Buyer,</b><br></br>
                                                            <p>
                                                                <h3>Thank you for your interest in our product <?php echo $product_name; ?>.</h3>
                                                                </br>
                                                                We are happy to inform you that above product is available. Click below link to
                                                                start shopping!</br></br>
                                                            <a href="<?php echo base_url($url); ?>" class="button-style" style="text-decoration:none; ">Shop Now!</a><br>
                                                            </p>
                                                        </td>
                                                    </tr>
