...
<head>
  ...
  <title> Welcome to ATZ Cart</title>
                      ...
                      <table cellpadding="0" cellspacing="0" width="100%" bgcolor="#ffffff">
                        <tr>
                          <td valign="top" style="padding-bottom:15px; background-color:#ffffff;">
                            <h1>Welcome to  ATZ Cart </h1>
                          </td>
                        </tr>
                        <tr>
                          <td valign="top" style="padding-bottom:20px; background-color:#ffffff;">
                            <b>Welcome <?php echo $name; ?></b><br>
                            <p>
												  Dear Valuable Customer, Thank you for choosing ATZ Cart as your
					bulk Ecommerce Platform. Enjoy our seamless Products and Services for your
					Requirements. Visit our Website www.atzcart.com to explore more OR You can simply Download our Mobile Application
					from Google Playstore or Apple Appstore.</p>
                          </td>
                        </tr>
