                                 ...
                                 <div class="col-lg-12">
                                    <div class="page-header-breadcrumb">
                                       <div class="text-center" style="margin-top:5px;">
                                          <img src="<?php echo base_url(); ?>assets/images/logo.png" alt="logo.png" height="50" width="150">
                                       </div>
                                    </div>
                                 </div>
												   ...
												   ?>
                                                      <div class="form-group row">
                                                         ...
                                                         <div class="col-md-4 col-lg-8">
                                                            <input id="email-2"  type="email" class="required form-control" value='<?php
                                                         ...
                                                         <div class="col-md-4 col-lg-2">
                                                            <?php
                                                               if(isset($verified_email))
                                                               {  } else {?>
                                                            <a href="#"  class="btn btn-info btn-sm" onclick="check_mail()">Verify</a>
                                                            <?php } ?>
                                                         </div>
                                                      </div>
                                                      <?php
                                                      ...
                                                      <div class="form-group row">
                                                         ...
                                                         <div class="col-md-1 col-lg-1">
                                                            ...
                                                            <img style="width:25px;  margin-top: 18px;" src="<?php echo base_url().'assets/refresh.png'; ?>" title="Refresh"/>
                                                            </a>
                                                         </div>
                                                      </div>
                                                      <?php } ?>
