...
<html xmlns="http://www.w3.org/1999/xhtml">
   <head>
      ...
      <title>ATX cONFIRMATION mAIL</title>
      <style type="text/css">
         * {
         margin:0;
         padding:0;
   ...
   <body bgcolor="#ffffff">
      <div align="center" style="margin:0 auto;max-width:600px;padding:0px 0px;box-sizing:border-box;border-radius:0px; border:1px solid #ccc">
            ...
            <tr class="header-background">
               <td class="header container" align="center">
                  <div class="content">
                     <span class="brand" >
                     <a href="#">
                     <img src="<?php echo base_url(); ?>assets/admin/images/logo.png" alt="atz Logo" width="150" style="padding:10px;">
                     </a>
                     </span>
                  </div>
               </td>
                              ...
                              <table class="body">
                                 <tr>
                                    ...
                                    <td class="body-padded">
                                       <div class="body-title">Email ID : <?php echo $email;?> </div>
                                       <h4 style="text-align:center;">Verify Your Account</h4>
                                       <br></br>
                                       <div style="text-align:center;"><a style="border:1px solid green;padding:8px;background-color:grey;color:#fff;" href="<?php echo base_url().'user/register/verify_email/'.$verify_link; ?>">Click to Verify</a></div>
