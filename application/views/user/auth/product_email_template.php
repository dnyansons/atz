                      ...
                      <table cellpadding="0" cellspacing="0" width="100%" bgcolor="#ffffff">
                        <tr>
                          <td valign="top" style="padding-bottom:15px; background-color:#ffffff;">
                            <h1>Ecommerce ATZ Website </h1>
                          </td>
                        </tr>
                        <tr>
                          <td valign="top" style="padding-bottom:20px; background-color:#ffffff;">
                            <b>New Product Added </b><br>
                             <p> <b>Product Name :</b>  <?php echo $products_name; ?></p></br>
								 <b>Product Model :</b>  <?php echo $products_model; ?></p></br>
								 <b>Product Quntity :</b>  <?php echo $products_quantity; ?></p></br>
								 <b>Product Description :</b>  <?php echo $products_description; ?></p></br>
								 <b>Product Price :</b>  <?php echo $products_price; ?></p></br>
								 <b>Product Currency :</b>  <?php echo $products_currency; ?></p></br>
								 <b>Added By :</b>  <?php echo $supplier_id; ?></p></br>
                          </td>
                        </tr>
                        <tr>
                          <td>
                            <table cellspacing="0" cellpadding="0" width="100%" bgcolor="#ffffff">
                              <tr>
                                <td style="width:200px;background:#008000;">
                                  ...
                                  style="background-color:#00002c;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:18px;line-height:40px;text-align:center;text-decoration:none;width:200px;-webkit-text-size-adjust:none;">Click Here</a>
                                    <!--[if mso]>
                                      </center>
                                    </v:rect>
                                  <![endif]--></div>
