<form action="<?php echo site_url(); ?>seller/companyprofile/export" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-6">
            <img class="img img-thumbnail" src="<?php echo base_url('uploads/images/companies/intro/').$company->logo;?>">
        </div>
    </div>
    <div class="form-group row">
