                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <a href="<?= base_url(); ?>user/wallet/initiated"><button class="btn btn-sm btn-primary ml-4">Initiated</button></a>
                                    ...
                                    <a href="<?= base_url(); ?>user/wallet/onhold"><button class="btn btn-sm btn-default ml-4">On Hold</button></a>
                                    </div>
                                </div>
...
<script>
 $(document).ready(function () {
    $('#walletTable').DataTable({
        ...
        serverSide: true,
        ajax:{
                 url: "<?php echo base_url('user/wallet/ajax_list_initiated') ?>",
                 dataType: "json",
                 type: "POST",
