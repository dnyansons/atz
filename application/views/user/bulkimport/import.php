                        ...
                        <div class="col-lg-4">
                            <div class="page-header-breadcrumb">
                                <ul class="breadcrumb-title">
                                    ...
                                    <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>seller/bulkimport">List</a>
                                    </li>
                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                ...
                                <div class="card-block">
                                    ...
                                    <form method="post" enctype="multipart/form-data" action="<?php echo site_url();?>seller/bulkimport/import">
