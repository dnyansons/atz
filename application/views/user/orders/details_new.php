                ...
                <?php if ($orderDetails[0]['orders_status_name'] == "Pending") { ?>
                    <!--<div class="card">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-12">                                  
                                    <a type="button" href="<?php echo base_url(); ?>seller/orders/order_reject/<?php echo $orderDetails[0]['orders_id']; ?>" onclick="return confirm('Are You sure want to Reject Order ?')" class="btn btn-danger btn-sm btn-outline-danger waves-effect">Reject Order</a>


                                    <button type="button" class="btn btn-primary btn-sm btn-outline-primary waves-effect pull-right" data-toggle="modal" data-target="#acceptOrder">Accept Order</button>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-12">                                  
                                    <?php
                                    if ($orderDetails[0]['orders_status'] == 20) {
                                        ?>
                                        ...
                                        <a type="button" href="<?php echo base_url(); ?>seller/orders/reject_cancel_request/<?php echo $orderDetails[0]['orders_id']; ?>" class="btn btn-success btn-sm">Reject Cancel Request</a>
                                    <?php }  if ($orderDetails[0]['orders_status'] != 10 && $orderDetails[0]['orders_status'] != 8 ) {
                                    ?>
                                    <a type="button" href="<?php echo base_url(); ?>seller/orders/sellerOrderDetailsInvoice/<?php echo $orderDetails[0]['orders_id']; ?>" >
                                    <button type="button" class="btn btn-warning btn-sm pull-right"  target="_blank">Seller Invoice!</button></a>

                                    <a type="button" href="<?php echo base_url(); ?>seller/orders/finalOrderInvoice/<?php echo $orderDetails[0]['orders_id']; ?>" >
                                        <button type="button" class="btn btn-warning btn-sm pull-right"  target="_blank">Buyer Invoice!</button></a>
                                    <?php } ?>

                                    <a type="button" href="<?php echo base_url(); ?>seller/orders/track_order/<?php echo $orderDetails[0]['orders_id']; ?>" class="btn btn-success btn-sm btn-outline-info waves-effect pull-right">Track Order</a>
                                        ...
                                        <div class="panel panel-default">
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                foreach ($orderDetails as $row) {
                                                    ?>
                                                    <tr>
                                                        <td><?php echo 'PRODID : ' . $row['product_id']; ?></td>
    ...
    <div id="acceptOrder" class="modal fade" role="dialog">
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-content">
                ...
                <form class="form-horizontal" action="<?php echo base_url(); ?>seller/orders/accept" method="post">
