                    ...
                    <div class="row align-items-end">
                        <div class="col-lg-8">
                            <div class="page-header-title">
                                <div class="d-inline">
                                    <h4>Inquiries Uploaded Files</h4>
                                    <span></span>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="page-header-breadcrumb">
                                <ul class="breadcrumb-title">
                                    ...
                                    <li class="breadcrumb-item"><a href="#">Inquiry Uploaded Files</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="page-body">
                    ...
                    <div class="card-header">
                        <div class="row">	
                            ...
                            { if(!empty($row)){ ?>
                                <iframe style="width:100%;height:450px;" src="<?php echo base_url().'uploads/inquiries_attachment/'.$row; ?>"></iframe>
                            <?php } }
                            ?>
						</div>
...
$('#inquiry_modal').on('show.bs.modal', function(e) {
	...
	if(attachment != '')
	{
		$("#attachment_link").html('<a href="<?php echo base_url();?>buyer/Inquiries/download_file/'+attachment+'" >download</a>');
	}else{
			 ...
			 success:function(response){
				...
				if(response.status== 1)
				{
				   location.reload();
					...
					alert(response.error+ "Please select pdf|doc|docx file!");
				}else {
