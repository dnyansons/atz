                        ...
                        <div class="col-lg-4">
                            <div class="page-header-breadcrumb">
                                <ul class="breadcrumb-title">
									...
									<li class="breadcrumb-item"><a href="<?php echo site_url(); ?>admin/report/commission_report">Profit/Loss Report</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
...
<script>
    $(document).ready(function () {
       var dtTable =  $('#salesreport').DataTable({
            ...
            ajax: {
                url: "<?php echo base_url('seller/report/fetch_profitloss_report') ?>",
                dataType: "json",
                type: "POST",
                data: function(data) {
