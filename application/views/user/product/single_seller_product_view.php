<?php $this->load->view("user/common/header"); ?>
                ...
                <div class="page-wrapper">
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <span class="col-md-5 text-dark">
                                <b>Publish Status : <i class="fa fa-check-circle text-success"
                                                       style="font-size: 18px;"></i></b>
                                <i><?php echo strtoupper($productData['product_details']->publish_status); ?></i>
                            </span>
                                <span class="col-md-2">
                            </span>
                                <span class="col-md-5 text-dark">
                    ...
                    <div class="page-body">
                        <div id="printOrder">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h5 class="font-weight-bold"><i class="fa fa-list-ol"></i> &nbsp; Product
                                        Specifications
                                    </h5>
                                </div>
                                <table class="table table-bordered">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="card-title">
                                    <h5 class="font-weight-bold"><i class="fa fa-align-justify"></i> &nbsp; Product
                                        Description
                                    </h5>
                                </div>
                                <p class="card-text">
    ...
    </div> <?php $this->load->view("user/common/footer"); ?>