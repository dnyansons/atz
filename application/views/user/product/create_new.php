                ...
                <div class="page-body">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form action="<?php echo site_url(); ?>seller/products/postNew" method="post" enctype="multipart/form-data" id="frm_post_new_product">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                ?>
                                                <a href="<?php echo base_url('seller/products/create/'); ?>" class="btn btn-sm btn-info">
                                                    Edit
                                                </a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" name="product_name" value="<?php echo set_value('product_name')?>" id="product_name" class="form-control" placeholder="Enter name of the product" onkeypress="return restrictAlphabets(event)">
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" name="product_keywords" value="<?php echo set_value('product_keywords')?>" id="product_keywords" class="form-control" maxlength="128"
                                        ...
                                        <?php if(count($attrs) > 0 || count($specs) > 0 ){ if(count($attrs) > 0) {?>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-6">
                                                    <?php if ($attr->type == "single_input") { ?>
                                                        <input type="text" class="form-control temp_val" data-did="<?php echo $attr->id; ?>"  <?php echo $required; ?>>
    ...
    <!--                                        <input type="hidden" name="spec_id[]" value="<?php echo $spec->id; ?>">-->
                                            <div class="form-group row">
                                                ...
                                                <?php if ($spec->type == "single_input") { ?>
                                                        <input type="text" class="form-control" name="spec_val[]" <?php echo $required; ?>>
                                                        ...
                                                        <div class="form-group row cloneme">
                                                            <div class="col-md-8">
                                                                <select class="form-control option_val" name="spec_val[]" <?php echo $required; ?> required>
                                                                    <option value="">Select option</option>
                                                                    <?php foreach ($options as $option) { ?>
                                                            ...
                                                            <div class="col-md-2">
                                                                <button type="button" class="btn btn-sm btn_clone_spec_color" onclick="multiplyByParent(this)">
                                                                    <i class="fa fa-plus"></i>
                                                                </button>
                                                                
                                                            </div>
                                                            <div class="col-md-2">
                                                                <button type="button" class="btn btn-sm rm_spec_size" onclick="removeByParent(this)">
                                ...
                                <div class="card" id="trade">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <label >
                                                    <input type="radio" value="1" name="buyers_place" checked > Yes
                                                    <input type="radio" value="0" name="buyers_place" > No
                                                </label>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <label >
                                                    <input type="radio" value="Yes" name="is_product_returnable" > Yes
                                                    <input type="radio" value="No" name="is_product_returnable" checked> No
                                                </label>
                                            </div>
                                        </div>

                                        
                                        <div id="returnable_div" style="display: none;">
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                ...
                                                <table id="policy" class="table table-striped table-bordered table-hover">
                                                    ...
                                                    <tbody>
                                                        <?php if(isset($ProductDetails_data['policy'])){ $policy_count=0; foreach($ProductDetails_data['policy'] as $pol){  ?>
                                                        
                                                        
                                                        <tr id="policy-row<?php echo $policy_count; ?>">
                                                            
                                                            <td class="text-left">
                                                                <textarea name="policy[]" id="product_policy<?php echo $policy_count; ?>" class="form-control policy"></textarea>
                                                                
                                                            </td>
                                                            
                                                            <td class="text-right"><button type="button" onclick="$('#policy-row<?php echo $img_count; ?>').remove();" data-toggle="tooltip" title="" class="btn btn-danger" data-original-title="Remove"><i class="fa fa-minus-circle"></i></button></td>
                                                        </tr>
                                                        <?php $policy_count++; } } ?>
                                                    </tbody>
                                                    <tfoot>
									...
									<div class="form-group row">
                                            <label class="contol-label col-md-2" data-toggle="tooltip" data-placement="top" title="Select Price Type for Setting Price for single product or 'Range of Multiple Products" >Price Type <span class="text-danger">*</span></label>
                                            <div class="col-md-6">
                                                <label >
                                                    <input type="radio" class="price_type" value="single" name="price_type" data-toggle="tooltip" data-placement="top" title="Set Price Per Unit Quantity" checked > Single
                                                    <input type="radio" class="price_type" value="uniform" name="price_type" data-toggle="tooltip" data-placement="top" title="Set Multiple Price on Product's Minimum Order Quantity Ranges" > Uniform
                                                </label>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="control-label col-md-2">Unit <span class="text-danger">*</span></label>
                                            <div class="col-md-6">
                                                <select class="form-control" name="unit" id="sel_unit">
                                                    <option value="">Select</option>
                                                    <?php echo $old_unit = set_Value('unit'); foreach ($units as $unit):  ?>
                                                    <option value="<?php echo $unit->units_id; ?>" <?php echo ($old_unit == $unit->units_id)? 'selected':'';?>><?php echo $unit->units_name; ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                            </div>
                                            <span class="text-danger">
                                        ...
                                        <div id="single_container">
                                            <div class="form-group row">
                                                <label class="control-label col-md-2">MOQ <span class="text-danger">*</span></label>
                                                <div class="col-md-3">
                                                    <input type="text" class="form-control" name="moq[]" id="moq_11" placeholder="Minimum order quantity" onkeypress="return restrictNumbers(event)" >
                                                </div>
                                                <div class="col-md-3">
                                                    <input type="text" class="form-control" name="price[]" id="price_11" placeholder="price per unit" onkeypress="return restrictPrice(event)">
                                                </div>
                                            </div>
                                        </div> 
                                        <div id="uniform_container" style="display:none;">
                                            <div class="form-group row">
                                                <label class="control-label col-md-2">MOQ </label>
                                                <div class="col-md-3">
                                                    <div class="input-group">
                                                        <span class="input-group-addon" id="basic-addon1">>=</span>
                                                        <input type="text" class="form-control" name="moq[]" id="moq_1" placeholder="Minimum order quantity" onkeypress="return restrictNumbers(event)" disabled>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <input type="text" class="form-control" name="price[]" id="price_1" placeholder="price per unit" disabled>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="control-label col-md-2">MOQ </label>
                                                <div class="col-md-3">
                                                    <div class="input-group">
                                                        <span class="input-group-addon" id="basic-addon1">>=</span>
                                                        <input type="text" class="form-control" name="moq[]" id="moq_2" placeholder="Minimum order quantity" onkeypress="return restrictNumbers(event)" disabled>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <input type="text" class="form-control" name="price[]" id="price_2" placeholder="price per unit" disabled>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="control-label col-md-2">MOQ </label>
                                                <div class="col-md-3">
                                                    <div class="input-group">
                                                        <span class="input-group-addon" id="basic-addon1">>=</span>
                                                        <input type="text" class="form-control" name="moq[]" id="moq_3" placeholder="Minimum order quantity" onkeypress="return restrictNumbers(event)" disabled>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <input type="text" class="form-control" name="price[]" id="price_3" placeholder="price per unit" disabled>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="control-label col-md-2">MOQ </label>
                                                <div class="col-md-3">
                                                    <div class="input-group">
                                                        <span class="input-group-addon" id="basic-addon1">>=</span>
                                                        <input type="text" class="form-control" name="moq[]" id="moq_4" placeholder="Minimum order quantity" onkeypress="return restrictNumbers(event)" disabled>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <input type="text" class="form-control" name="price[]" id="price_4" placeholder="price per unit" disabled>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="card" id="trade">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input ml-1" type="radio" value="0" name="track_inventory" id="dont_track_inventory">
                                                    <label class="form-check-label ml-1" for="dont_track_inventory">Don't Track My Inventory</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input ml-1" type="radio" value="1" name="track_inventory" id="track_inventory" checked>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" name="available_quantity" value="<?php echo set_value('available_quantity')?>" placeholder="Enter available quantity" id="available_quantity" maxlength="20">
                                            </div>
                                            <span class="text-danger">
...
<!--                                        </div>-->
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" name="low_stock_quantity" value="<?php echo set_value('low_stock_quantity')?>" placeholder="Enter Minimum Quantity to Notify" id="low_stock_quantity">
                                            </div>
                                            <span class="text-danger">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <label>
                                                    <input type="checkbox" id="chk_notify" value="1" name="chk_notify" checked> Notify me when reach at Minimum Quantity
                                                </label>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" name="remain_quantity" value="<?php echo set_value('remain_quantity')?>" placeholder="Current available quantity" id="remain_quantity" readonly>
                                            </div>
                                            <span class="text-danger">
                                ...
                                <div class="card">
                                    <div class="card-body" id="logistic">
                                        <h4 class="sub-title">Logistics information</h4>
                                        <p class="text-muted">
                                            Enter per unit packaging size dimensions and per unit weight.
                                        </p>
                                        <div class="form-group row">
                                            <label class="contol-label col-md-2">Weight (in Kg) <span class="text-danger">*</span>
                                            </label>
                                            <div class="col-md-6">
                                                <input type="text" name="weight" id="weight" class="form-control" value="<?php echo  set_value('weight'); ?>" onkeypress="return restrictNumbers(event)" >
                                            </div>
                                            <span class="text-danger">
                                        ...
                                        <div class="form-group row">
                                            <label class="contol-label col-md-2">Width (in CM) <span class="text-danger">*</span>
                                            </label>
                                            <div class="col-md-6">
                                                <input type="text" name="width" id="width" class="form-control" value="<?php echo  set_value('width'); ?>" onkeypress="return restrictNumbers(event)">
                                            </div>
                                            <span class="text-danger">
                                        ...
                                        <div class="form-group row">
                                            <label class="contol-label col-md-2">Height (in CM) <span class="text-danger">*</span>
                                            </label>
                                            <div class="col-md-6">
                                                <input type="text" name="height" class="form-control" value="<?php echo  set_value('height'); ?>" onkeypress="return restrictNumbers(event)">
                                            </div>
                                            <span class="text-danger">
                                        ...
                                        <div class="form-group row">
                                            <label class="contol-label col-md-2">Length (in CM) <span class="text-danger">*</span>
                                            </label>
                                            <div class="col-md-6">
                                                <input type="text" name="length" id="length" class="form-control" value="<?php echo  set_value('length'); ?>" onkeypress="return restrictNumbers(event)">
                                            </div>
                                            <span class="text-danger">
                                ...
                                <div class="card">
                                    <div class="card-body" id="description">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <label class="contol-label col-md-2">Images
                                            </label>
                                            <div class="col-md-10">
                ...
                <table id="images" class="table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        { 
                            $img_count=0; foreach($ProductDetails_data['images'] as $imgd){  ?>
                        ...
                        <tr id="image-row<?php echo $img_count; ?>" class="imgtr">
                            <td class="text-left">
                            ...
                            <td class="text-right"><button type="button" onclick="addImage();" data-toggle="tooltip" title="" class="btn btn-primary" data-original-title="Add Image"><i class="fa fa-plus-circle"></i></button></td>
                                       ...
                                       <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <textarea class="ckeditor" name="products_description" id="products_description" required rows="4"></textarea>
                                            </div>
...
<script>
    $("#dont_track_inventory").click(function(){
        $("#inventory_quantity").val('');
        $("#remain_quantity").val('');
        $("#low_stock_quantity").val('');
        $("#inventory_quantity").attr('readonly',true);
        $("#low_stock_quantity").attr('readonly',true);
        $("#inventory_quantity").attr('required',false);
        $("#low_stock_quantity").attr('required',false);
    })
    
    $("#track_inventory").click(function(){
         var available_qty = $("#available_quantity").val();
        $("#inventory_quantity").val(available_qty);
        $("#remain_quantity").val(available_qty);
        
        $("#inventory_quantity").attr('readonly',false);
        $("#low_stock_quantity").attr('readonly',false);
        $("#inventory_quantity").attr('required',true);
        $("#low_stock_quantity").attr('required',true);
    })
...
<script>
    ...
    function removeByParent(input)
    {
        var uniqueId = $(input).parent().parent().children(':first-child');
        var cloneFirstOnly = $(input).parent().parent();
        console.log($(cloneFirstOnly).last().children('.col-md-8:last-child').remove());
    }
...
<script type="text/javascript">
  ...
  function addImage() {
    ...
    images_tr_count=parseInt($(".imgtr").length)+1;
    if(images_tr_count<=6){
    html  = '<tr id="image-row' + image_row + '" class="imgtr">';
    html += '  <td class="text-left"><img src="#" id="product_image_show'+image_row+'" alt="No Image" title="" height=70 width=150/></td>';
...
<script type="text/javascript">
  ...
  $('input[name=is_product_returnable]').click(function(){
    ...
    $(document).ready(function(){
        ...
        $('#available_quantity').on('keypress', function (event) {
        ...
        $("#frm_post_new_product").validate({
            ...
            rules : {
                ...
                "price[]":"required",
                "moq[]":"required",
                "product_hidden_image_file[]":"required",

            },
            messages : {
                product_name : {
                    required : "Enter Product name",
                    maxlength : "Maximum 256 characters only"
                },
                product_keywords : {
                    required : "Enter Keywords",
                    maxlength : "Enter maximum 128 characters"
                },
                available_quantity : {
                    required : "Enter quantiry",
                ...
                products_description : "Enter detailed description",
                unit : "Select Unit",
                "price[]":"Price is required",
                "moq[]":"Minimum order quantity",
                "product_image_file[]":"Please select minimum 1 image",
            },
