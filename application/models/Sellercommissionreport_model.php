...
class Sellercommissionreport_model extends CI_Model
{
    ...
    {   
       $this->db->select("concat(c.first_name,' ',c.last_name) as vendorname,c.phone as vendorphone,concat('ORD',a.orders_id) as orders_id,a.date_purchased,a.delivery_date,a.order_price,a.vendor_payable_price,d.amount");
