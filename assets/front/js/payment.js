      ...
      $.ajax({
		 ...
		 // get Promotion details
           ...
           // alert(paymentOption.replace("OPT",""));
			...
			/*
    			APPEND CREDIT CARD PROVIDED LIST
    		*/
			/*
				$.each(jsonData, function(index,value) {
	           		//console.log(value);
				...
				$.each(jsonData, function(index,value) {
           		...
           		if(paymentOption !="OPTEMI"){
	            	 if(value.payOpt==paymentOption){
	            		...
	            		/*
	            			APPEND DEBIT CARD PROVIDED LIST
	            		*/
		                	/*
			                	$.each(cardArray, function() {
				...
				$.each(jsonData, function(index,value) {
           		...
           		if(paymentOption !="OPTEMI"){
	            	 if(value.payOpt==paymentOption){
	            		...
	            		/*
	            			APPEND NET BANKING PROVIDED LIST
	            		*/
	                	/*
		                	$.each(cardArray, function() {
			...
			$(".nb_card_name").empty();
         	...
         	$.each(jsonData, function(index,value) { 		
		  			if(value.payOpt=="OPTEMI"){
						...
						/*
	            			APPEND EMI PROVIDED TABLE LIST
	            		*/
		                	/*
...
function cardFormValidate(){
    ...
    //card number validation
      var cvvNumber=$("#cvv_number").val();

    if($("#card_name").val()=="" || $("#card_number").val() == "" || $("#expiry_month").val()=="" || $("#expiry_year").val()=="") {
